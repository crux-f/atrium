...
summon minecraft:evoker ~ ~ ~ {Team:"atrium_armada",PersistenceRequired:1b,Health:48f,Tags:["atrium_armada_necromancer","atrium_hiding"],CustomName:{text:"Armada Necromancer","color":"red","italic":false},Attributes:[{Name:"generic.max_health",Base:48}]}
#
