...
execute as @e[type=minecraft:pillager,tag=atrium_currently_hiding,scores={atrium_hiding=30}] run data remove entity @s equipment
...
execute as @e[type=minecraft:pillager,tag=atrium_currently_hiding,tag=atrium_armada_engineer,scores={atrium_hiding=30..}] at @s if entity @a[distance=..15,gamemode=survival] run data merge entity @s {Silent:false,equipment:{mainhand:{id:"minecraft:iron_pickaxe",count:1,components:{"minecraft:custom_model_data":{strings:["atrium_hammer"]}}}}}
execute as @e[type=minecraft:pillager,tag=atrium_currently_hiding,tag=atrium_armada_infiltrator,scores={atrium_hiding=30..}] at @s if entity @a[distance=..15,gamemode=survival] run data merge entity @s {Silent:false,equipment:{mainhand:{id:"minecraft:crossbow",count:1,components:{"minecraft:enchantments":{"minecraft:quick_charge":3,"minecraft:piercing":1}}},offhand:{id:"minecraft:tipped_arrow",count:2,components:{"minecraft:custom_name":{"italic":false,"text":"Negative Energy olt"},"minecraft:lore":["Infused with dark magic,","these crossbow bolts are","only granted to operatives","involved in missions which","require discretion."],"minecraft:custom_data":{atrium_negative_energy_bolt:1b},"minecraft:potion_contents":"minecraft:harming"}},feet:{id:"minecraft:leather_boots",count:1,components:{"minecraft:enchantments":{"minecraft:protection":1,"minecraft:soul_speed":3}}},legs:{id:"minecraft:leather_leggings",count:1,components:{"minecraft:enchantments":{"minecraft:protection":1,"minecraft:swift_sneak":1}}},chest:{id:"minecraft:leather_chestplate",count:1,components:{"minecraft:enchantments":{"minecraft:protection":1}}},head:{id:"minecraft:observer",count:1,components:{"minecraft:block_state":{powered:"true"}}}}}
