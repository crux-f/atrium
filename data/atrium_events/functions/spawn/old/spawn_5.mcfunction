...
execute as @p[distance=..10,gamemode=!spectator,advancements={atrium:air_start=false,atrium:earth_start=false,atrium:fire_start=false,atrium:water_start=false}] in atrium:between_worlds run tp @s 36734.5 230 -3247.5
