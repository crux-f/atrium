...
execute as @a run data modify entity @s[tag=atrium_hidden_propagandist,scores={charge=0..2}] Gossips[0].Target set from entity @s UUID
#
...
execute as @a run data modify entity @s[tag=atrium_hidden_propagandist,scores={charge=3..6}] Gossips[0].Target set from entity @s UUID
#
...
execute as @a run data modify entity @s[tag=atrium_hidden_propagandist,scores={charge=7..12}] Gossips[0].Target set from entity @s UUID
#
...
execute as @a run data modify entity @s[tag=atrium_hidden_propagandist,scores={charge=13..24}] Gossips[0].Target set from entity @s UUID
#
...
execute as @a run data modify entity @s[tag=atrium_hidden_propagandist,scores={charge=25..}] Gossips[0].Target set from entity @s UUID
