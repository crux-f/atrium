...
execute if data entity @s data.cooking_station_installed positioned ~3 ~ ~-2 run kill @e[limit=1,type=minecraft:item_frame,distance=..1.5,nbt={Facing:1b,Item:{components:{"minecraft:custom_data":{atrium_cooking_knife:1b}}}}]
#
execute if data entity @s data.cooking_station_installed run summon minecraft:item ~ ~1 ~ {NoGravity:1b,Glowing:1b,Item:{id:"minecraft:crafting_table",count:1}}
execute if data entity @s data.cooking_station_installed run summon minecraft:item ~ ~1 ~ {NoGravity:1b,Glowing:1b,Item:{id:"minecraft:oak_stairs",count:1}}
execute if data entity @s data.cooking_station_installed run summon minecraft:item ~ ~1 ~ {NoGravity:1b,Glowing:1b,Item:{id:"minecraft:item_frame",count:1}}
execute if data entity @s data.cooking_station_installed run summon minecraft:item ~ ~1 ~ {NoGravity:1b,Glowing:1b,Item:{id:"minecraft:iron_ingot",count:1}}
kill @s
# Cleanup
