...
execute positioned ~ ~ ~ run summon item ~ ~1 ~ {NoGravity:1b,Glowing:1b,Item:{id:"minecraft:player_head",count:1b,components:{"minecraft:lore":['{"text":"Space Required:","color":"gray","italic":false}','{"text":"x9,y5,z11","color":"dark_gray","italic":false}','{"text":" "}','{"text":"When Placed:","color":"gray","italic":false}','{"text":"Generates a structure ","color":"blue","italic":false}'],"minecraft:item_name":'{"text":"Infusion Circle"}',"minecraft:profile":{id:[I;-510246894,-974372697,-1324757754,-2046207321],name:"",properties:[{name:"textures",value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYTIyNzYzMDkzNzc0NjkzYjI2MzkyNzhhMWMyYzY5OGFkMTFkYjQ5Mjg5NmU5YmYxNjcxNGQ4NTdlOThjYTFkZCJ9fX0="}]},"minecraft:custom_data":{infusion_circle_placer:1b}}}}
#
...
execute if data entity @s data.warp_gate_installed run summon minecraft:item ~ ~1 ~ {NoGravity:1b,Glowing:1b,Item:{id:"minecraft:stick",count:1b,components:{"minecraft:custom_model_data":333059,"minecraft:item_name":'{"text":"Inert Focus"}',"minecraft:custom_data":{atrium_inert_focus:1b}}}}
execute if data entity @s data.warp_gate_installed run summon minecraft:item ~ ~1 ~ {NoGravity:1b,Glowing:1b,Item:{id:"minecraft:blue_stained_glass",count:1b,components:{"minecraft:lore":['{"text":"It feels like chilled"}','{"text":"glass. You can almost"}','{"text":"feel it contemplating."}'],"minecraft:attribute_modifiers":{modifiers:[{amount:2,name:"generic.armor_toughness",operation:"add_value",slot:"mainhand",type:"generic.armor_toughness",uuid:[I;-2123071529,1345407694,-1756066510,1972665159]},{amount:1,name:"generic.armor_toughness",operation:"add_value",slot:"offhand",type:"generic.armor_toughness",uuid:[I;1626373228,-1354218532,-1339331348,773807433]},{amount:4,name:"generic.armor",operation:"add_value",slot:"mainhand",type:"generic.armor",uuid:[I;-1101675602,-1514387537,-1111860716,857932385]},{amount:2,name:"generic.armor",operation:"add_value",slot:"offhand",type:"generic.armor",uuid:[I;-2058357322,1857374624,-1166773954,1459387628]}]},"minecraft:enchantments":{levels:{"minecraft:unbreaking":1},show_in_tooltip:0b},"minecraft:item_name":'{"text":"Calm Crystal","color":"blue"}',"minecraft:custom_data":{atrium_calm_crystal:1b}}}}
# Remove entity
kill @s
# Cleanup
