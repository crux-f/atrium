...
execute positioned ~-6 ~3 ~-1 if data entity @s data.warp_gate_installed run setblock ~ ~ ~ minecraft:air
#
execute if entity @s[tag=atrium_warp_gate_installed] run summon minecraft:item ~ ~1 ~ {NoGravity:1b,Glowing:1b,Item:{id:"minecraft:lodestone",count:1}}
execute if entity @s[tag=atrium_warp_gate_installed] run summon minecraft:item ~ ~1 ~ {NoGravity:1b,Glowing:1b,Item:{id:"minecraft:stone",count:4}}
execute if entity @s[tag=atrium_warp_gate_installed] run summon minecraft:item ~ ~1 ~ {NoGravity:1b,Glowing:1b,Item:{id:"minecraft:amethyst_block",count:1,components:{"minecraft:enchantment_glint_override":true,"minecraft:lore":[{text:"Harmonizing","color":"light_purple","italic":false},{text:" "},{text:"A little extra music can"},{text:"help even the most"},{text:"disparate elements get along."}],"minecraft:item_name":{text:"Infusion Catalyst"},"minecraft:custom_data":{atrium_catalyst_harmonizing:1b}}}}
execute if entity @s[tag=atrium_warp_gate_installed] run summon minecraft:item ~ ~1 ~ {NoGravity:1b,Glowing:1b,Item:{id:"minecraft:ender_pearl",count:2}}
execute if entity @s[tag=atrium_warp_gate_installed] run summon minecraft:item ~ ~1 ~ {NoGravity:1b,Glowing:1b,Item:{id:"minecraft:stick",count:1,components:{"minecraft:custom_model_data":{strings:["atrium_inert_focus"]},"minecraft:item_name":{text:"Inert Focus"},"minecraft:custom_data":{atrium_inert_focus:1b}}}}
execute if entity @s[tag=atrium_warp_gate_installed] run summon minecraft:item ~ ~1 ~ {NoGravity:1b,Glowing:1b,Item:{id:"minecraft:blue_stained_glass",count:1,components:{"minecraft:lore":[{text:"It feels like chilled"},{text:"glass. You can almost"},{text:"feel it contemplating."}],"minecraft:attribute_modifiers":[{amount:2,id:"atrium:calm_crystal_armor_toughness_mainhand",operation:"add_value",slot:"mainhand",type:"armor_toughness"},{amount:1,id:"atrium:calm_crystal_armor_toughness_offhand",operation:"add_value",slot:"offhand",type:"armor_toughness"},{amount:4,id:"atrium:calm_crystal_armor_mainhand",operation:"add_value",slot:"mainhand",type:"armor"},{amount:2,id:"atrium:calm_crystal_armor_mainhand",operation:"add_value",slot:"offhand",type:"armor"}],"minecraft:enchantments":{"minecraft:unbreaking":1},"minecraft:item_name":{text:"Calm Crystal","color":"blue"},"minecraft:custom_data":{atrium_calm_crystal:1b}}}}
# Remove entity
kill @s
# Cleanup
