...
execute if data entity @s {Inventory:[{Slot:-106b,components:{"minecraft:custom_data":{atrium_patron:"konigin12"}}}]} if data entity @s {Inventory:[{Slot:4b}]} unless data entity @s {Inventory:[{Slot:4b,components:{"minecraft:custom_data":{atrium_power:1b}}}]} run function atrium:items/slot_control/drop_item_4
