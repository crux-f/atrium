...
#
execute positioned ~2 ~2 ~2 unless entity @e[type=minecraft:glow_item_frame,distance=..1.5,nbt={Item:{id:"minecraft:emerald",count:1}}] run return 0
execute positioned ~-2 ~2 ~2 unless entity @e[type=minecraft:glow_item_frame,distance=..1.5,nbt={Item:{id:"minecraft:emerald",count:1}}] run return 0
execute positioned ~2 ~2 ~-2 unless entity @e[type=minecraft:glow_item_frame,distance=..1.5,nbt={Item:{id:"minecraft:emerald",count:1}}] run return 0
execute positioned ~-2 ~2 ~-2 unless entity @e[type=minecraft:glow_item_frame,distance=..1.5,nbt={Item:{id:"minecraft:emerald",count:1}}] run return 0
#
...
execute positioned ~ ~2 ~ as @p[gamemode=!spectator,distance=..2] run effect give @s minecraft:levitation 65 9 false
...
execute positioned ~ ~2 ~ as @p[gamemode=!spectator,distance=..2] run effect give @s minecraft:slow_falling 110 0 false
