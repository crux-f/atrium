...
execute at @e[tag=atrium_chain_lightning_1_spell_warning] if predicate atrium:percentage_chances/0.50_p at @p[distance=3..10] run function atrium:entities/mob_spells/chain_lightning_2_setup
