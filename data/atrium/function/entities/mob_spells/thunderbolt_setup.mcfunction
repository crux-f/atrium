...
summon marker ~ ~ ~ {CustomNameVisible:0b,Tags:["atrium_thunderbolt_spell_warning"],CustomName:{text:"Thunderbolt Spell Warning","color":"yellow","italic":false}}
...
playsound minecraft:item.trident.thunder hostile @a[distance=..30] ~ ~ ~ 0.75 0.75 0.1
...
schedule function atrium:entities/mob_spells/thunderbolt_summon 1s
# Reset score
