...
summon marker ~ ~ ~ {CustomNameVisible:0b,Tags:["atrium_chain_lightning_1_spell_warning"],CustomName:{text:"Thunderbolt Spell Warning","color":"yellow","italic":false}}
...
playsound minecraft:item.trident.thunder hostile @a[distance=..30] ~ ~ ~ 0.75 1 0.1
...
schedule function atrium:entities/mob_spells/chain_lightning_summon_1 1s
# Reset score
