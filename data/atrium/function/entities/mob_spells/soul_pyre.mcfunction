...
execute at @e[tag=atrium_soul_pyre_victim] run summon area_effect_cloud ~ ~ ~ {CustomNameVisible:0b,ReapplicationDelay:20,Radius:1.25f,RadiusPerTick:0f,RadiusOnUse:0f,Duration:600,potion_contents:{potion:"minecraft:harming"},Tags:["atrium_soul_pyre"],CustomName:{"color":"aqua","text":"Soul Pyre"}}
