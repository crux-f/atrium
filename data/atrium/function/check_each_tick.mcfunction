...
execute as @e[tag=atrium_special] run function atrium:general/special_entity_manager
# Special Condition Manager
execute as @e[tag=atrium_condition] run function atrium:entities/condition_manager
