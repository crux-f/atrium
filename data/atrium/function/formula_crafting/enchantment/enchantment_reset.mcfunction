...
#
# NORTH
execute positioned ~ ~ ~-3 run data merge entity @e[type=minecraft:glow_item_frame,distance=..1,limit=1] {Facing:1b,Invisible:1b,Tags:["atrium_crafting_slot"],Item:{}}
execute positioned ~ ~ ~-3 run data remove entity @e[type=minecraft:glow_item_frame,distance=..1,limit=1] Item
execute positioned ~ ~ ~-3 run particle minecraft:enchant ~ ~ ~ 0.1 0.5 0.1 0.1 2
# NORTH-EAST
execute positioned ~2 ~ ~-2 run data merge entity @e[type=minecraft:glow_item_frame,distance=..1,limit=1] {Facing:1b,Invisible:1b,Tags:["atrium_crafting_slot"],Item:{}}
...
execute positioned ~-2 ~ ~-2 run particle minecraft:enchant ~ ~ ~ 0.1 0.5 0.1 0.1 2
# Particles!
particle minecraft:enchant ~ ~1 ~ 0.3 0.3 0.3 0.1 200 normal
# Sound!
