...
execute if entity @s[scores={valid_ingredients=6..}] as @e[limit=1,sort=nearest,tag=atrium_codex_product_placeholder] run data modify entity @s Item.tag.atrium_concentration_lv set value 3b
execute if entity @s[scores={valid_ingredients=6..}] as @e[limit=1,sort=nearest,tag=atrium_codex_product_placeholder] run data modify entity @s Item.tag.display.Lore[0] set value '{"text":"Concentration III","italic":false,"color":"gray"}'
