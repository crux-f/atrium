...
execute if entity @s[scores={valid_ingredients=4..}] as @n[type=item,tag=atrium_formula_product,distance=..7] run data modify entity @s Item.components.minecraft:enchantments.atrium:concentration set value 3
