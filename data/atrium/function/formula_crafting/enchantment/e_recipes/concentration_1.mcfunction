...
#
# Check NORTH EAST for any item enchanted with Protection
execute positioned ~2 ~ ~-2 at @e[type=minecraft:glow_item_frame,distance=..1.5,nbt={Item:{tag:{Enchantments:[{id:"minecraft:protection"}]}}}] run particle minecraft:enchanted_hit ~ ~ ~ 0 0 0 0.1 20 normal
execute positioned ~2 ~ ~-2 if entity @e[type=minecraft:glow_item_frame,distance=..1.5,nbt={Item:{tag:{Enchantments:[{id:"minecraft:protection"}]}}}] run scoreboard players add @s valid_ingredients 1
execute positioned ~2 ~ ~-2 at @e[type=minecraft:glow_item_frame,distance=..1.5,nbt={Item:{tag:{StoredEnchantments:[{id:"minecraft:protection"}]}}}] run particle minecraft:enchanted_hit ~ ~ ~ 0 0 0 0.1 20 normal
execute positioned ~2 ~ ~-2 if entity @e[type=minecraft:glow_item_frame,distance=..1.5,nbt={Item:{tag:{StoredEnchantments:[{id:"minecraft:protection"}]}}}] run scoreboard players add @s valid_ingredients 1
...
execute if entity @s[scores={valid_ingredients=6..}] as @e[limit=1,sort=nearest,tag=atrium_codex_product_placeholder] run data merge entity @s {Item:{tag:{Enchantments:[{}],RepairCost:3,atrium_custom_enchantment:1b,atrium_concentration_enchanted:1b,atrium_concentration_lv:1b}}}
execute if entity @s[scores={valid_ingredients=6..}] as @e[limit=1,sort=nearest,tag=atrium_codex_product_placeholder] run data modify entity @s Item.tag.display.Lore prepend value '{"text":"Concentration I","italic":false,"color":"gray"}'
