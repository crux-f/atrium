...
execute positioned ~2 ~ ~-2 if data entity @e[type=minecraft:glow_item_frame,distance=..1.5,limit=1] Item.components.minecraft:enchantments.levels.minecraft:protection run particle minecraft:enchanted_hit ~ ~ ~ 0 0 0 0.1 20 normal
execute positioned ~2 ~ ~-2 if data entity @e[type=minecraft:glow_item_frame,distance=..1.5,limit=1] Item.components.minecraft:enchantments.levels.minecraft:protection run scoreboard players add @s valid_ingredients 1
execute positioned ~2 ~ ~-2 if data entity @e[type=minecraft:glow_item_frame,distance=..1.5,limit=1] Item.components.minecraft:stored_enchantments.levels.minecraft:protection run particle minecraft:enchanted_hit ~ ~ ~ 0 0 0 0.1 20 normal
execute positioned ~2 ~ ~-2 if data entity @e[type=minecraft:glow_item_frame,distance=..1.5,limit=1] Item.components.minecraft:stored_enchantments.levels.minecraft:protection run scoreboard players add @s valid_ingredients 1
...
execute if entity @s[scores={valid_ingredients=5..}] as @e[limit=1,sort=nearest,tag=atrium_formula_product] run data merge entity @s {Item:{components:{"minecraft:enchantments":{levels:{"atrium:concentration": 1}}}}}
