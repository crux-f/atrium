...
execute if entity @s[scores={valid_ingredients=4..}] as @e[limit=1,sort=nearest,tag=atrium_formula_product] run data modify entity @s Item.components.minecraft:enchantments.atrium:concentration set value 2
