...
execute if entity @s[scores={valid_ingredients=11..}] as @e[limit=1,sort=nearest,tag=atrium_formula_product] run data merge entity @s {Item:{components:{"minecraft:enchantments":{"atrium:surge": 1}}}}
