...
execute if entity @s[scores={valid_ingredients=11..}] as @n[type=item,tag=atrium_formula_product,distance=..7] run data merge entity @s {Item:{components:{"minecraft:enchantments":{"atrium:surge": 1}}}}
