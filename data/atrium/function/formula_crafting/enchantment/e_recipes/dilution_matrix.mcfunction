...
execute if entity @s[scores={valid_ingredients=5..}] at @s run item replace entity @e[limit=1,sort=nearest,tag=atrium_formula_product] container.0 with minecraft:amethyst_shard[minecraft:custom_model_data=333175,minecraft:lore=['{"text":"This chaotic device mimics"}','{"text":"the conversion process found in"}','{"text":"Sculk to advance arcane"}','{"text":"achievement. It\'s probably fine!"}'],minecraft:item_name='{"text":"Dilution Matrix","italic":false}',minecraft:custom_data={atrium_dilution_matrix:1b}]
