...
execute positioned ~-2 ~ ~-2 if data entity @e[type=minecraft:glow_item_frame,distance=..1.5,limit=1] Item.components.minecraft:enchantments.levels.minecraft:piercing at @s run function atrium:formula_crafting/enchantment/e_recipes/backstabbing_1
execute positioned ~-2 ~ ~-2 as @e[type=minecraft:glow_item_frame,distance=..1.5] if data entity @s Item.components.minecraft:stored_enchantments.levels.minecraft:piercing at @s run particle minecraft:enchanted_hit ~ ~ ~ 0 0 0 0.1 20 normal
...
execute positioned ~-2 ~ ~-2 if data entity @e[type=minecraft:glow_item_frame,distance=..1.5,limit=1] Item.components.minecraft:enchantments.levels.minecraft:blast_protection at @s run function atrium:formula_crafting/enchantment/e_recipes/fuse_cutter
execute positioned ~-2 ~ ~-2 if data entity @e[type=minecraft:glow_item_frame,distance=..1.5,limit=1] Item.components.minecraft:stored_enchantments.levels.minecraft:blast_protection run particle minecraft:enchanted_hit ~ ~ ~ 0 0 0 0.1 20 normal
...
execute positioned ~-2 ~ ~-2 if data entity @e[type=minecraft:glow_item_frame,distance=..1.5,limit=1] Item.components.minecraft:enchantments.levels.minecraft:unbreaking at @s run function atrium:formula_crafting/enchantment/e_recipes/sentinel
execute positioned ~-2 ~ ~-2 if data entity @e[type=minecraft:glow_item_frame,distance=..1.5,limit=1] Item.components.minecraft:stored_enchantments.levels.minecraft:unbreaking run particle minecraft:enchanted_hit ~ ~ ~ 0 0 0 0.1 20 normal
execute positioned ~-2 ~ ~-2 if data entity @e[type=minecraft:glow_item_frame,distance=..1.5,limit=1] Item.components.minecraft:stored_enchantments.levels.minecraft:unbreaking at @s run function atrium:formula_crafting/enchantment/e_recipes/sentinel
#
# Start Concentration I - Check NORTH WEST for any item enchanted with Respiration
execute positioned ~-2 ~ ~-2 if data entity @e[type=minecraft:glow_item_frame,distance=..1.5,limit=1] Item.components.minecraft:enchantments.levels.minecraft:respiration run particle minecraft:enchanted_hit ~ ~ ~ 0 0 0 0.1 20 normal
execute positioned ~-2 ~ ~-2 if data entity @e[type=minecraft:glow_item_frame,distance=..1.5,limit=1] Item.components.minecraft:enchantments.levels.minecraft:respiration at @s run function atrium:formula_crafting/enchantment/e_recipes/concentration_1
execute positioned ~-2 ~ ~-2 if data entity @e[type=minecraft:glow_item_frame,distance=..1.5,limit=1] Item.components.minecraft:stored_enchantments.levels.minecraft:respiration run particle minecraft:enchanted_hit ~ ~ ~ 0 0 0 0.1 20 normal
...
execute positioned ~-2 ~ ~-2 if data entity @e[type=minecraft:glow_item_frame,distance=..1.5,limit=1] Item.components.minecraft:enchantments.levels.minecraft:fire_aspect at @s run function atrium:formula_crafting/enchantment/e_recipes/smelting
execute positioned ~-2 ~ ~-2 if data entity @e[type=minecraft:glow_item_frame,distance=..1.5,limit=1] Item.components.minecraft:stored_enchantments.levels.minecraft:fire_aspect run particle minecraft:enchanted_hit ~ ~ ~ 0 0 0 0.1 20 normal
execute positioned ~-2 ~ ~-2 if data entity @e[type=minecraft:glow_item_frame,distance=..1.5,limit=1] Item.components.minecraft:stored_enchantments.levels.minecraft:fire_aspect at @s run function atrium:formula_crafting/enchantment/e_recipes/smelting
#
...
execute positioned ~ ~ ~-3 at @e[type=minecraft:glow_item_frame,distance=..1.5,nbt={Item:{id:"minecraft:diamond_sword",components:{"minecraft:damage": 0}}}] run particle minecraft:enchanted_hit ~ ~ ~ 0 0 0 0.1 20 normal
execute positioned ~ ~ ~-3 if entity @e[type=minecraft:glow_item_frame,distance=..1.5,nbt={Item:{id:"minecraft:diamond_sword",components:{"minecraft:damage": 0}}}] at @s run function atrium:formula_crafting/enchantment/e_recipes/trident
# 