...
#
execute if entity @s[scores={valid_ingredients=3..}] at @s run summon item ~ ~1 ~ {Motion:[0.0,0.02,0.0],NoGravity:1b,Glowing:1b,Item:{id:"minecraft:potion",Count:1b,components:{"minecraft:item_name":'{"text":"Potion of Invisibility"}',"minecraft:custom_model_data":333067,"minecraft:custom_data":{atrium_tier_3_potion:1b,atrium_potion:"longer_invisibility"},"minecraft:potion_contents":{custom_effects:[{id:"minecraft:invisibility",amplifier:0,duration:20400}]}}}}
