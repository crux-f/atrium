...
#
execute if entity @s[scores={valid_ingredients=3..}] at @s run summon item ~ ~1 ~ {Motion:[0.0,0.02,0.0],NoGravity:1b,Glowing:1b,Item:{id:"minecraft:beetroot_soup",components:{"minecraft:custom_model_data":333169,"minecraft:item_name":'{"text":"Dark Sauce"}',"minecraft:custom_data":{atrium_dark_sauce:1b}}}}
