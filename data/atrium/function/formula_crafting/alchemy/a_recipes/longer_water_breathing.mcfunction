...
# Check NORTH for Nautilus Shell
...
#
execute if entity @s[scores={valid_ingredients=3..}] at @s run summon item ~ ~1 ~ {Motion:[0.0,0.02,0.0],NoGravity:1b,Glowing:1b,Item:{id:"minecraft:potion",components:{"minecraft:item_name":'{"text":"Potion of Water Breathing"}',"minecraft:custom_model_data":{strings:["atrium_advanced_potion"]},"minecraft:custom_data":{atrium_tier_3_potion:1b,atrium_potion:"longer_water_breathing"},"minecraft:potion_contents":{custom_effects:[{id:"minecraft:water_breathing",amplifier:0,duration:20400}]}}}}
