...
# 2 - Potion of Fire Resistance (3:00)
# 3 - Potion of Fire Resistance (3:00)
execute positioned ~-3 ~1 ~-2 if data block ~ ~ ~ {Items:[{id:"minecraft:potion",components:{"minecraft:potion_contents":{potion:"minecraft:fire_resistance"}}},{id:"minecraft:potion",components:{"minecraft:potion_contents":{potion:"minecraft:fire_resistance"}}},{id:"minecraft:potion",components:{"minecraft:potion_contents":{potion:"minecraft:fire_resistance"}}}]} run scoreboard players add @s valid_ingredients 1
#
