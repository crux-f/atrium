...
# 1 - Potion of Night Vision (8:00)
# 2 - Potion of Night Vision (8:00)
# 3 - Potion of Night Vision (8:00)
execute positioned ~-3 ~1 ~-2 if data block ~ ~ ~ {Items:[{id:"minecraft:potion",components:{"minecraft:potion_contents":{potion:"minecraft:long_night_vision"}}},{id:"minecraft:potion",components:{"minecraft:potion_contents":{potion:"minecraft:long_night_vision"}}},{id:"minecraft:potion",components:{"minecraft:potion_contents":{potion:"minecraft:long_night_vision"}}}]} run scoreboard players add @s valid_ingredients 1
#
