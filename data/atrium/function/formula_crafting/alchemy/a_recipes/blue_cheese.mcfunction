...
#
execute if entity @s[scores={valid_ingredients=4..}] at @s run summon item ~ ~1 ~ {Motion:[0.0,0.02,0.0],NoGravity:1b,Glowing:1b,Item:{id:"minecraft:baked_potato",count:1,components:{"minecraft:custom_model_data":{strings:["atrium_lue_cheese"]},"minecraft:item_name":{text:'Blue Cheese'},"minecraft:custom_data":{atrium_blue_cheese:1b}}}}
