...
execute if entity @s[scores={valid_ingredients=4..}] at @s run item replace entity @e[limit=1,sort=nearest,tag=atrium_formula_product] container.0 with minecraft:potion[minecraft:custom_model_data=333165,minecraft:item_name='{"text":"Sweet Berry Wine"}',minecraft:custom_data={atrium_sweet_berry_wine:1b},minecraft:potion_contents={custom_color:13041664,custom_effects:[{amplifier:0b,duration:120,id:"minecraft:nausea",show_particles:1b},{amplifier:0b,duration:1200,id:"minecraft:regeneration",show_particles:1b},{amplifier:3b,duration:20,id:"minecraft:saturation",show_particles:1b}]}]
