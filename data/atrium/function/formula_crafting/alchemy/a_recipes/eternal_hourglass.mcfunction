...
#
execute if entity @s[scores={valid_ingredients=3..}] at @s run summon item ~ ~1 ~ {Motion:[0.0,0.02,0.0],NoGravity:1b,Glowing:1b,Item:{id:"minecraft:glass_bottle",components:{"minecraft:item_name":{text:'Eternal Hourglass'},"minecraft:lore":[{"text":"While the sand drains out"},{"text":"of the top, more sand drifts"},{"text":"upward, disobeying gravity."}],"minecraft:custom_model_data":{strings:["atrium_eternal_hourglass"]},"minecraft:custom_data":{atrium_eternal_hourglass:1b},"minecraft:enchantment_glint_override":true}}}
