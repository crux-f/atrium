...
#
execute if entity @s[scores={valid_ingredients=4..}] at @s run summon item ~ ~1 ~ {Motion:[0.0,0.02,0.0],NoGravity:1b,Glowing:1b,Item:{id:"minecraft:cod",components:{"minecraft:custom_model_data":{strings:["atrium_butter"]},"minecraft:item_name":{text:'Butter'},"minecraft:custom_data":{atrium_butter:1b}}}}
...
execute if entity @s[scores={valid_ingredients=4..}] at @s run summon item ~ ~1 ~ {Motion:[0.0,0.0,0.0],NoGravity:1b,Glowing:1b,Item:{id:"minecraft:stick"}}
