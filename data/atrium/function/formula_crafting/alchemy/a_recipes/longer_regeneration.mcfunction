...
execute if entity @s[scores={valid_ingredients=3..}] at @s run item replace entity @e[limit=1,sort=nearest,tag=atrium_formula_product] container.0 with potion[minecraft:item_name='{"text":"Potion of Regeneration"}',minecraft:custom_model_data=333067,minecraft:custom_data={atrium_tier_3_potion:1b,atrium_potion:"longer_regeneration"},minecraft:potion_contents={custom_effects:[{id:"minecraft:regeneration",amplifier:0,duration:4800}]}] 1
