...
execute if entity @s[scores={valid_ingredients=3..}] at @s run item replace entity @e[limit=1,sort=nearest,tag=atrium_formula_product] container.0 with potion[minecraft:custom_name={text:'Potion of Regeneration',italic:false},minecraft:custom_model_data={strings:["atrium_advanced_potion"]},minecraft:custom_data={atrium_tier_3_potion:1b,atrium_potion:"longer_regeneration"},minecraft:potion_contents={custom_effects:[{id:"minecraft:regeneration",amplifier:0,duration:4800}]}] 1
