...
execute if entity @s[scores={valid_ingredients=5..}] at @s run item replace entity @n[type=item,tag=atrium_formula_product,distance=..7] container.0 with minecraft:beetroot_soup[minecraft:custom_model_data={strings:["atrium_pasta"]},minecraft:item_name={text:'Pasta'},minecraft:custom_data={atrium_pasta:1b}]
