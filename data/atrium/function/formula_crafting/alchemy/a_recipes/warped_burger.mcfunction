...
execute if entity @s[scores={valid_ingredients=4..}] at @s run item replace entity @e[limit=1,sort=nearest,tag=atrium_formula_product] container.0 with minecraft:cooked_porkchop[minecraft:custom_model_data=333195,minecraft:item_name='{"text":"Warped Burger"}',minecraft:custom_data={atrium_warped_burger:1b},minecraft:food={nutrition:11,saturation:11,is_meat:false,eat_seconds:3}]
