...
execute positioned ~-2 ~ ~ if entity @e[type=minecraft:glow_item_frame,distance=..1.5,nbt={Item:{id:"minecraft:arrow"}}] run scoreboard players add @s valid_ingredients 1
...
# 1 - Potion of Swiftness II (1:30)
# 2 - Potion of Swiftness II (1:30)
# 3 - Potion of Swiftness II (1:30)
execute positioned ~-3 ~1 ~-2 if data block ~ ~ ~ {Items:[{id:"minecraft:potion",components:{"minecraft:potion_contents":{potion:"minecraft:strong_swiftness"}}},{id:"minecraft:potion",components:{"minecraft:potion_contents":{potion:"minecraft:strong_swiftness"}}},{id:"minecraft:potion",components:{"minecraft:potion_contents":{potion:"minecraft:strong_swiftness"}}}]} run scoreboard players add @s valid_ingredients 1
#
...
execute if entity @s[scores={valid_ingredients=5..}] at @s run item replace entity @n[type=item,tag=atrium_formula_product,distance=..7] container.0 with minecraft:potion[custom_data={atrium_carafe_potion:1b,atrium_potion_doses:3},custom_model_data={strings:["atrium_multiuse_potion_full"]},potion_contents={potion:"minecraft:strong_swiftness"},use_remainder={id:"minecraft:potion",count:1,components:{"minecraft:custom_data":{atrium_carafe_potion:1b,atrium_potion_doses:2},"minecraft:custom_model_data":{strings:["atrium_multiuse_potion_half"]},"minecraft:potion_contents":{potion:"minecraft:strong_swiftness"},"minecraft:use_remainder":{id:"minecraft:potion",count:1,components:{"minecraft:custom_data":{atrium_carafe_potion:1b,atrium_potion_doses:1},"minecraft:custom_model_data":{strings:["atrium_multiuse_potion_final"]},"minecraft:potion_contents":{potion:"minecraft:strong_swiftness"},"minecraft:use_remainder":{id:"minecraft:glass_bottle",count:1,components:{"minecraft:custom_data":{atrium_crystal_bottle:1b},"minecraft:custom_model_data":{strings:["atrium_crystal_bottle"]},"minecraft:item_name":"Crystal Bottle"}},"minecraft:lore":[["",{"color":"gray","italic":false,"text":"Doses Left:"},{"color":"blue","italic":false,"text":" 1"}]]}},"minecraft:lore":[["",{"color":"gray","italic":false,"text":"Doses Left:"},{"color":"blue","italic":false,"text":" 2"}]]}},lore=[[{"color":"gray","italic":false,"text":"Doses Left:"},{"color":"blue","italic":false,"text":" 3"}]],custom_name={"italic":false,"text":"Carafe of Swiftness"}]
