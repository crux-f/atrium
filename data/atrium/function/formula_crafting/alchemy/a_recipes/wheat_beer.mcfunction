...
execute if entity @s[scores={valid_ingredients=4..}] at @s run item replace entity @e[limit=1,sort=nearest,tag=atrium_formula_product] container.0 with minecraft:potion[minecraft:custom_model_data=333192,minecraft:item_name='{"text":"Wheat Beer"}',minecraft:custom_data={atrium_wheat_beer:1b},minecraft:potion_contents={custom_color:11893511,custom_effects:[{ambient:1b,amplifier:0b,duration:2400,id:"minecraft:mining_fatigue",show_icon:1b},{amplifier:1b,duration:100,id:"minecraft:saturation",show_icon:0b,show_particles:0b}]}]
