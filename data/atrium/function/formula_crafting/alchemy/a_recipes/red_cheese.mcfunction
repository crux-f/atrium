...
execute if entity @s[scores={valid_ingredients=4..}] at @s run item replace entity @e[limit=1,sort=nearest,tag=atrium_formula_product] container.0 with minecraft:baked_potato[minecraft:custom_model_data=333163,minecraft:item_name='{"text":"Red Cheese"}',minecraft:custom_data={atrium_red_cheese:1b}]
...
# Give items back
execute if entity @s[scores={valid_ingredients=4..}] at @s run summon item ~ ~1 ~ {Motion:[0.0,0.0,0.0],NoGravity:1b,Glowing:1b,Item:{id:"minecraft:blue_wool"}}
