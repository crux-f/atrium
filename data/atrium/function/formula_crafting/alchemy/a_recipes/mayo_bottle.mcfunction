...
execute if entity @s[scores={valid_ingredients=4..}] at @s run item replace entity @e[limit=1,sort=nearest,tag=atrium_formula_product] container.0 with minecraft:potion[minecraft:custom_model_data=333166,minecraft:item_name='{"text":"Mayo Bottle"}',minecraft:custom_data={atrium_mayo_bottle:1b},minecraft:hide_additional_tooltip={},minecraft:potion_contents={custom_color:16383912,custom_effects:[{amplifier:0b,duration:2400,id:"minecraft:nausea",show_icon:1b,show_particles:1b}]}]
