...
execute positioned ~-2 ~ ~ at @e[type=minecraft:glow_item_frame,distance=..1.5,nbt={Item:{id:"minecraft:smooth_stone"}}] run particle minecraft:enchanted_hit ~ ~ ~ 0 0 0 0.1 20 normal
execute positioned ~-2 ~ ~ if entity @e[type=minecraft:glow_item_frame,distance=..1.5,nbt={Item:{id:"minecraft:smooth_stone"}}] run scoreboard players add @s valid_ingredients 1
# Check EAST for Smooth Stone
execute positioned ~2 ~ ~ at @e[type=minecraft:glow_item_frame,distance=..1.5,nbt={Item:{id:"minecraft:smooth_stone"}}] run particle minecraft:enchanted_hit ~ ~ ~ 0 0 0 0.1 20 normal
execute positioned ~2 ~ ~ if entity @e[type=minecraft:glow_item_frame,distance=..1.5,nbt={Item:{id:"minecraft:smooth_stone"}}] run scoreboard players add @s valid_ingredients 1
# Check SOUTH for Mundane Potion
...
#
execute if entity @s[scores={valid_ingredients=3..}] at @s run summon item ~ ~1 ~ {Motion:[0.0,0.02,0.0],NoGravity:1b,Glowing:1b,Item:{id:"minecraft:glass_bottle",components:{"minecraft:item_name":{text:'Essence of Anachronism'},"minecraft:lore":[{"text":"This substance seems"},{"text":"to be in the wrong time."}],"minecraft:custom_model_data":{strings:["atrium_essence_of_anachronism"]},"minecraft:custom_data":{atrium_essence_of_anachronism:1b}}}}
