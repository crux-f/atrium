...
#
execute if entity @s[scores={valid_ingredients=3..}] at @s run summon item ~ ~1 ~ {Motion:[0.0,0.02,0.0],NoGravity:1b,Glowing:1b,Item:{id:"minecraft:potion",components:{"minecraft:item_name":'{"text":"Potion of Healing"}',"minecraft:custom_model_data":333067,"minecraft:custom_data":{atrium_tier_3_potion:1b,atrium_potion:"stronger_healing"},"minecraft:potion_contents":{custom_effects:[{id:"minecraft:instant_health",amplifier:2,duration:1}]}}}}
