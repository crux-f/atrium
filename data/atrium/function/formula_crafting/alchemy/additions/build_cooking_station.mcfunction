...
# Decor
execute positioned ~3 ~1 ~-2 run summon minecraft:item_frame ~ ~ ~ {Fixed:1b,Facing:1b,Item:{id:"minecraft:iron_sword",count:1,components:{"minecraft:custom_model_data":333138,"minecraft:item_name":'{"text":"Cooking Knife"}',"minecraft:lore":['{"text":"Ideally, you aren\'t"}','{"text":"able to read this."}']}}}