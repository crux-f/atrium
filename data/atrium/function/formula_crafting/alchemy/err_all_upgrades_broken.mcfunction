...
execute positioned ~ ~ ~-7 run tellraw @p[gamemode=!spectator] {"text":"(The cauldron, lab or station is damaged. It requires all blocks to function.)","italic":true,"color":"red"}