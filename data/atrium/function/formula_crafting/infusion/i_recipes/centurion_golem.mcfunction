...
#
execute if entity @s[scores={valid_ingredients=11..}] at @s run summon iron_golem ~ ~ ~ {DeathLootTable:"atrium:entities/centurion_golem",PersistenceRequired:1b,Health:200f,PlayerCreated:1b,Tags:["atrium_centurion_golem"],CustomName:'{"text":"Centurion Golem"}',equipment:{mainhand:{id:"minecraft:iron_sword",count:1,components:{"minecraft:unbreakable":{},"minecraft:enchantments":{"minecraft:knockback":1,"minecraft:sharpness":2}}}},drop_chances:{mainhand:0},attributes:[{id:max_health,base:200},{id:scale,base:1.2}]}
