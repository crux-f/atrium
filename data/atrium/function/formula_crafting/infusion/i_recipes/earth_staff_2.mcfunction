...
execute positioned ~ ~ ~-2 at @e[type=minecraft:glow_item_frame,distance=..1.5,nbt={Item:{components:{"minecraft:custom_data":{atrium_earth_staff:1b,atrium_staff_lv:1b}}}}] run particle minecraft:enchanted_hit ~ ~ ~ 0 0 0 0.1 20 normal
execute positioned ~ ~ ~-2 if entity @e[type=minecraft:glow_item_frame,distance=..1.5,nbt={Item:{components:{"minecraft:custom_data":{atrium_earth_staff:1b,atrium_staff_lv:1b}}}}] run scoreboard players add @s valid_ingredients 1
...
execute positioned ~ ~ ~4 at @e[type=minecraft:glow_item_frame,distance=..1.5,nbt={Item:{id:"minecraft:oak_sapling"}}] run particle minecraft:enchanted_hit ~ ~ ~ 0 0 0 0.1 20 normal
execute positioned ~ ~ ~4 if entity @e[type=minecraft:glow_item_frame,distance=..1.5,nbt={Item:{id:"minecraft:oak_sapling"}}] run scoreboard players add @s valid_ingredients 1
#
...
execute if entity @s[scores={valid_ingredients=5..}] at @s run item replace entity @e[limit=1,sort=nearest,tag=atrium_formula_product] container.0 with minecraft:diamond_hoe[minecraft:custom_model_data={strings:["atrium_earth_staff"]},minecraft:lore=['{"text":"◇ Earth Sigil II","color":"gray","italic":false}','{"text":"◇ Natural Armor II","color":"gray","italic":false}','{"text":"◇ Locate Ore I","color":"gray","italic":false}','{"text":"◇ Conjure Tree I","color":"gray","italic":false}','{"text":" "}','{"text":"When in Off Hand:","color":"gray","italic":false}','{"text":"+2 Casting Power","color":"blue","italic":false}'],minecraft:attribute_modifiers={modifiers:[{amount:2,operation:"add_value",slot:"mainhand",type:"attack_damage",id:"atrium:staff_attack_damage"}]},minecraft:item_name='{"text":"Staff of Earth"}',minecraft:custom_data={atrium_chargeable:1b,atrium_earth_staff:1b,atrium_staff:1b,atrium_staff_lv:2b}] 1
