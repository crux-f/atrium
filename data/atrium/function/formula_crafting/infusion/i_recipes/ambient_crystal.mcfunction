...
execute if entity @s[scores={valid_ingredients=11..}] at @s run item replace entity @e[limit=1,sort=nearest,tag=atrium_formula_product] container.0 with minecraft:yellow_stained_glass[minecraft:lore=['{"text":"It hums pleasantly"}','{"text":"in your hands, warm to"}','{"text":"the touch."}'],minecraft:attribute_modifiers={modifiers:[{amount:4,operation:"add_value",slot:"mainhand",type:"max_health",id:"atrium:ambient_crystal_max_health_mainhand"},{amount:2,operation:"add_value",slot:"offhand",type:"max_health",id:"atrium:ambient_crystal_max_health_offhand"}]},minecraft:enchantments={levels:{"minecraft:protection":1},show_in_tooltip:0b},minecraft:item_name='{"text":"Ambient Crystal","color":"yellow"}',minecraft:custom_data={atrium_ambient_crystal:1b}] 1
