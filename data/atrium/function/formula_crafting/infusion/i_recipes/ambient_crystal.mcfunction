...
execute if entity @s[scores={valid_ingredients=11..}] at @s run item replace entity @e[limit=1,sort=nearest,tag=atrium_formula_product] container.0 with minecraft:yellow_stained_glass[minecraft:lore=['{"text":"It hums pleasantly"}','{"text":"in your hands, warm to"}','{"text":"the touch."}'],minecraft:attribute_modifiers={modifiers:[{amount:4,name:"generic.max_health",operation:"add_value",slot:"mainhand",type:"generic.max_health",uuid:[I;-143642502,1820738489,-2017495337,1454137543]},{amount:2,name:"generic.max_health",operation:"add_value",slot:"offhand",type:"generic.max_health",uuid:[I;-1773544178,-681160812,-1421706757,-638844973]}]},minecraft:enchantments={levels:{"minecraft:protection":1},show_in_tooltip:0b},minecraft:item_name='{"text":"Ambient Crystal","color":"yellow"}',minecraft:custom_data={atrium_ambient_crystal:1b}]
