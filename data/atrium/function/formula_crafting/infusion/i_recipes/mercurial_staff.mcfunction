...
execute positioned ~ ~ ~2 if entity @e[type=minecraft:glow_item_frame,distance=..1.5,nbt={Item:{id:"minecraft:brewing_stand"}}] run scoreboard players add @s valid_ingredients 1
...
execute if entity @s[scores={valid_ingredients=9..}] at @s run item replace entity @e[limit=1,sort=nearest,tag=atrium_formula_product] container.0 with minecraft:diamond_hoe[minecraft:custom_model_data={strings:["atrium_mercurial_staff"]},minecraft:lore=['{"text":"◇ Destabilize Item","color":"gray","italic":false}','{"text":"◇ Fizzle Spell","color":"gray","italic":false}','{"text":"✦ Catalyze","color":"dark_purple","italic":false}','{"text":" "}','{"text":"When in Off Hand:","color":"gray","italic":false}','{"text":"+3 Casting Power","color":"blue","italic":false}'],minecraft:attribute_modifiers={modifiers:[{amount:2,operation:"add_value",slot:"mainhand",type:"attack_damage",id:"atrium:staff_attack_damage"}]},minecraft:item_name='{"text":"Mercurial Staff"}',minecraft:custom_data={atrium_chargeable:1b,atrium_mercurial_staff:1b,atrium_special_staff:1b,atrium_staff:1b,atrium_staff_lv:3b}]
