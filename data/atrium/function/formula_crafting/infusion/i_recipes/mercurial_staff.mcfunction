...
execute if entity @s[scores={valid_ingredients=9..}] at @s run item replace entity @e[limit=1,sort=nearest,tag=atrium_formula_product] container.0 with minecraft:diamond_hoe[minecraft:custom_model_data=333188,minecraft:lore=['{"text":"◇ Destabilize Item","color":"gray","italic":false}','{"text":"◇ Fizzle Spell","color":"gray","italic":false}','{"text":"✦ Catalyze","color":"dark_purple","italic":false}','{"text":" "}','{"text":"When in Off Hand:","color":"gray","italic":false}','{"text":"+3 Casting Power","color":"blue","italic":false}'],minecraft:attribute_modifiers={modifiers:[{amount:2,name:"generic.attack_damage",operation:"add_value",slot:"mainhand",type:"generic.attack_damage",uuid:[I;637717026,1710441391,-1943706047,783506473]}]},minecraft:item_name='{"text":"Mercurial Staff"}',minecraft:custom_data={atrium_chargeable:1b,atrium_mercurial_staff:1b,atrium_special_staff:1b,atrium_staff:1b,atrium_staff_lv:3b}]
