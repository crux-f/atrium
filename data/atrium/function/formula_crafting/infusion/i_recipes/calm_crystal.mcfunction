...
execute if entity @s[scores={valid_ingredients=11..}] at @s run item replace entity @e[limit=1,sort=nearest,tag=atrium_formula_product] container.0 with minecraft:blue_stained_glass[minecraft:lore=['{"text":"It feels like chilled"}','{"text":"glass. You can almost"}','{"text":"feel it contemplating."}'],minecraft:attribute_modifiers={modifiers:[{amount:2,name:"generic.armor_toughness",operation:"add_value",slot:"mainhand",type:"generic.armor_toughness",uuid:[I;-2123071529,1345407694,-1756066510,1972665159]},{amount:1,name:"generic.armor_toughness",operation:"add_value",slot:"offhand",type:"generic.armor_toughness",uuid:[I;1626373228,-1354218532,-1339331348,773807433]},{amount:4,name:"generic.armor",operation:"add_value",slot:"mainhand",type:"generic.armor",uuid:[I;-1101675602,-1514387537,-1111860716,857932385]},{amount:2,name:"generic.armor",operation:"add_value",slot:"offhand",type:"generic.armor",uuid:[I;-2058357322,1857374624,-1166773954,1459387628]}]},minecraft:enchantments={levels:{"minecraft:unbreaking":1},show_in_tooltip:0b},minecraft:item_name='{"text":"Calm Crystal","color":"blue"}',minecraft:custom_data={atrium_calm_crystal:1b}]
