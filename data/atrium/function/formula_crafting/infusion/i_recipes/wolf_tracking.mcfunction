...
execute as @e[tag=atrium_enchantable_wolf,tag=atrium_enchanted_wolf,distance=..10] run data merge entity @s {Tags:["atrium_enchanted_wolf","atrium_hunting_enchanted","atrium_special","atrium_particle","atrium_dust_sometimes"],HandItems:[{id:"minecraft:clock",count:1,components:{"minecraft:attribute_modifiers":[{type:"generic.movement_speed",id:"atrium:tracking_infusion_movement_speed",amount:0.3,operation:"add_multiplied_base",slot:"mainhand"}]}},{}],HandDropChances:[-327.670F,0.085F]}
