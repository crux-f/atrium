...
execute if entity @s[scores={valid_ingredients=11..}] at @s run item replace entity @e[limit=1,sort=nearest,tag=atrium_formula_product] container.0 with minecraft:red_stained_glass[minecraft:lore=['{"text":"It pulses and sparks with"}','{"text":"pent-up energy."}'],minecraft:attribute_modifiers={modifiers:[{amount:3,operation:"add_value",slot:"mainhand",type:"generic.attack_damage",id:"atrium:eager_crystal_attack_damage_mainhand"},{amount:0.15d,operation:"add_multiplied_base",slot:"mainhand",type:"generic.attack_speed",id:"atrium:eager_crystal_attack_speed_mainhand"},{amount:1,operation:"add_value",slot:"offhand",type:"generic.attack_damage",id:"atrium:eager_crystal_attack_damage_offhand"},{amount:0.07d,operation:"add_multiplied_base",slot:"offhand",type:"generic.attack_speed",id:"atrium:eager_crystal_attack_speed_offhand"}]},minecraft:enchantments={levels:{"minecraft:unbreaking":1},show_in_tooltip:0b},minecraft:item_name='{"text":"Eager Crystal","color":"red"}',minecraft:custom_data={atrium_eager_crystal:1b}] 1
