...
execute if entity @s[scores={valid_ingredients=11..}] at @s run item replace entity @e[limit=1,sort=nearest,tag=atrium_formula_product] container.0 with minecraft:clay_ball[minecraft:custom_model_data=333174,minecraft:lore=['{"text":"A culmination of all"}','{"text":"the minerals beneath "}','{"text":"the earth."}'],minecraft:item_name='{"text":"Mountain\'s Root"}',minecraft:custom_data={atrium_mountains_root:1b}]
