...
execute if entity @s[scores={valid_ingredients=12..}] at @s run item replace entity @e[limit=1,sort=nearest,tag=atrium_formula_product] container.0 with minecraft:elytra[minecraft:custom_model_data={strings:["atrium_dreamers_wings"]},minecraft:lore=[{"text":"The light of the aurora"},{"text":"dances within its feathers."}],minecraft:enchantments={"minecraft:mending":1,"minecraft:unbreaking":3},minecraft:item_name={text:"Dreamer's Wings"},minecraft:custom_data={atrium_dreamers_wings:1b},minecraft:rarity="rare"]
