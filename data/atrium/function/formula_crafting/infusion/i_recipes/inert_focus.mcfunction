...
execute if entity @s[scores={valid_ingredients=3..}] at @s run item replace entity @e[limit=1,sort=nearest,tag=atrium_formula_product] container.0 with minecraft:stick[minecraft:custom_model_data={strings:["atrium_inert_focus"]},minecraft:item_name='{"text":"Inert Focus"}',minecraft:custom_data={atrium_inert_focus:1b}]
