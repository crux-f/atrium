...
execute positioned ~-2 ~ ~ at @e[type=minecraft:glow_item_frame,distance=..1.5,nbt={Item:{id:"minecraft:chest"}}] run particle minecraft:enchanted_hit ~ ~ ~ 0 0 0 0.1 20 normal
execute positioned ~-2 ~ ~ if entity @e[type=minecraft:glow_item_frame,distance=..1.5,nbt={Item:{id:"minecraft:chest"}}] run scoreboard players add @s valid_ingredients 1
# Check CENTER EAST for Chest
execute positioned ~2 ~ ~ at @e[type=minecraft:glow_item_frame,distance=..1.5,nbt={Item:{id:"minecraft:chest"}}] run particle minecraft:enchanted_hit ~ ~ ~ 0 0 0 0.1 20 normal
execute positioned ~2 ~ ~ if entity @e[type=minecraft:glow_item_frame,distance=..1.5,nbt={Item:{id:"minecraft:chest"}}] run scoreboard players add @s valid_ingredients 1
# Check SOUTH for Infusion Catalyst [Harmonizing]
execute positioned ~ ~ ~4 at @e[type=minecraft:glow_item_frame,distance=..1.5,nbt={Item:{components:{"minecraft:custom_data":{atrium_catalyst_reverberating:1b}}}}] run particle minecraft:enchanted_hit ~ ~ ~ 0 0 0 0.1 20 normal
execute positioned ~ ~ ~4 if entity @e[type=minecraft:glow_item_frame,distance=..1.5,nbt={Item:{components:{"minecraft:custom_data":{atrium_catalyst_reverberating:1b}}}}] run scoreboard players add @s valid_ingredients 1
#
...
execute if entity @s[scores={valid_ingredients=4..}] at @s run item replace entity @n[type=item,tag=atrium_formula_product,distance=..7] container.0 with minecraft:stick[minecraft:custom_model_data={strings:["atrium_rod_of_relocation"]},minecraft:lore=[{"text":"◇ Condense Structure","color":"gray","italic":false},{"text":" "},{"text":"When in Main Hand:","color":"gray","italic":false},{"text":"+1 Casting Power","color":"blue","italic":false}],minecraft:item_name={text:'Rod of Relocation'},minecraft:custom_data={atrium_rod_of_relocation:1b}]
