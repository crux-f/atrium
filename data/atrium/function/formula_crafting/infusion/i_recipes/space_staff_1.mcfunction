...
execute if entity @s[scores={valid_ingredients=9..}] at @s run item replace entity @e[limit=1,sort=nearest,tag=atrium_formula_product] container.0 with minecraft:diamond_hoe[minecraft:custom_model_data=333065,minecraft:lore=['{"text":"◇ Space Sigil I","color":"gray","italic":false}','{"text":"◇ Parallax I","color":"gray","italic":false}','{"text":" "}','{"text":"When in Off Hand:","color":"gray","italic":false}','{"text":"+1 Casting Power","color":"blue","italic":false}'],minecraft:attribute_modifiers={modifiers:[{amount:2,name:"generic.attack_damage",operation:"add_value",slot:"mainhand",type:"generic.attack_damage",uuid:[I;637717026,1710441391,-1943706047,783506473]}]},minecraft:item_name='{"text":"Staff of Space"}',minecraft:custom_data={atrium_chargeable:1b,atrium_space_staff:1b,atrium_staff:1b,atrium_staff_lv:1b}]
