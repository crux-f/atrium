...
execute as @e[tag=atrium_enchantable_wolf,tag=atrium_enchanted_wolf,distance=..10] run data merge entity @s {Tags:["atrium_enchanted_wolf","atrium_ricochet_pelt_enchanted","atrium_special","atrium_particle","atrium_dust_sometimes"],ArmorItems:[{},{id:"minecraft:leather_leggings",count:1,components:{"minecraft:unbreakable":{},"minecraft:enchantments":{levels:{"minecraft:projectile_protection":2}}}},{id:"minecraft:leather_chestplate",count:1,components:{"minecraft:unbreakable":{},"minecraft:enchantments":{levels:{"minecraft:projectile_protection":2}}}},{id:"minecraft:leather_helmet",count:1,components:{"minecraft:unbreakable":{},"minecraft:enchantments":{levels:{"minecraft:projectile_protection":2}}}}],ArmorDropChances:[0.0F,-327.670F,-327.670F,-327.670F]}
