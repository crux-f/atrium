...
execute as @e[tag=atrium_enchantable_wolf,tag=atrium_enchanted_wolf,distance=..10] run data merge entity @s {Tags:["atrium_enchanted_wolf","atrium_ricochet_pelt_enchanted","atrium_special","atrium_particle","atrium_dust_sometimes"],equipment:{head:{id:"minecraft:leather_helmet",count:1,components:{"minecraft:unreakable":{},"minecraft:enchantments":{"minecraft:projectile_protection":2}}},chest:{id:"minecraft:leather_chestplate",count:1,components:{"minecraft:unreakable":{},"minecraft:enchantments":{"minecraft:projectile_protection":2}}},legs:{id:"minecraft:leather_leggings",count:1,components:{"minecraft:unreakable":{},"minecraft:enchantments":{"minecraft:projectile_protection":2}}}},drop_chances:{head:0,chest:0,legs:0}}
