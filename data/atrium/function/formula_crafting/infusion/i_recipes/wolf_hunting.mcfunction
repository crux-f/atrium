...
execute as @e[tag=atrium_enchantable_wolf,tag=atrium_enchanted_wolf,distance=..10] run data merge entity @s {Tags:["atrium_enchanted_wolf","atrium_hunting_enchanted","atrium_special","atrium_particle","atrium_dust_sometimes"],equipment:{mainhand:{id:"minecraft:iron_sword",count:1,components:{"minecraft:unreakable":{},"minecraft:enchantments":{"minecraft:looting":1}}}},drop_chances:{mainhand:0}}
