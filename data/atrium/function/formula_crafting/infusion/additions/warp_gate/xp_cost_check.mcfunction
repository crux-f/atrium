...
execute at @s positioned ~-5 ~2 ~ as @e[type=minecraft:item_frame,distance=..1.5,nbt={Item:{components:{"minecraft:enchantments":{levels:{"minecraft:lure":1}}}}}] run scoreboard players set @s atrium_xp_multiplier -99
execute at @s positioned ~-5 ~2 ~ as @e[type=minecraft:item_frame,distance=..1.5,nbt={Item:{components:{"minecraft:lodestone_tracker":{}}}},nbt=!{Item:{components:{"minecraft:enchantments":{levels:{"minecraft:lure":1}}}}}] run scoreboard players set @s atrium_xp_multiplier -95
#
