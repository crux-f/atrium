# Remove 2 from the praying player's favor for the main 10 gods. (Since 2 was added this will result in +1 to chosen god, -1 to all others)
# Doesn't go below 0.
#
...
#
scoreboard players remove @s[scores={aurora_favor=2..}] aurora_favor 2
scoreboard players remove @s[scores={chorus_favor=2..}] chorus_favor 2
scoreboard players remove @s[scores={geota_favor=2..}] geota_favor 2
scoreboard players remove @s[scores={ghael_favor=2..}] ghael_favor 2
scoreboard players remove @s[scores={messorum_favor=2..}] messorum_favor 2
scoreboard players remove @s[scores={nox_favor=2..}] nox_favor 2
scoreboard players remove @s[scores={oswald_favor=2..}] oswald_favor 2
scoreboard players remove @s[scores={quipster_favor=2..}] quipster_favor 2
scoreboard players remove @s[scores={syrula_favor=2..}] syrula_favor 2
scoreboard players remove @s[scores={taraqsol_favor=2..}] taraqsol_favor 2
#
# Reduce favor with each of the old gods by 1.
