...
particle minecraft:raid_omen ~ ~ ~ 0.1 0.25 0.1 0 15 normal
playsound atrium:favor.maw neutral @a[distance=..10] ~ ~ ~ 1 1 0.1
...
execute if entity @s[scores={maw_favor=1..9}] run effect give @s minecraft:fire_resistance 300 0
...
execute if entity @s[scores={maw_favor=10..19}] run effect give @s minecraft:fire_resistance 450 0
...
execute if entity @s[scores={maw_favor=20..29}] run effect give @s minecraft:fire_resistance 900 0
...
execute if entity @s[scores={maw_favor=30}] run effect give @s minecraft:fire_resistance 1700 0
