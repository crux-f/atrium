...
particle minecraft:warped_spore ~ ~ ~ 0.1 0.25 0.1 0 15 normal
playsound atrium:favor.xenos neutral @a[distance=..10] ~ ~ ~ 1 1 0.1
...
execute if entity @s[scores={xenos_favor=20..29}] run effect give @s minecraft:haste 900 2
...
execute if entity @s[scores={xenos_favor=30}] run effect give @s minecraft:haste 1700 2
