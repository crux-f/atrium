...
particle minecraft:happy_villager ~ ~ ~ 0.1 0.25 0.1 0.01 30 force
playsound atrium:favor.geota neutral @a[distance=..10] ~ ~ ~ 1 1 0.1
...
execute if entity @s[scores={geota_favor=20..29}] run effect give @s minecraft:haste 2400 1
...
execute if entity @s[scores={geota_favor=30}] run effect give @s minecraft:haste 2400 1
execute if entity @s[scores={geota_favor=30}] run effect give @s minecraft:jump_boost 2400 1
