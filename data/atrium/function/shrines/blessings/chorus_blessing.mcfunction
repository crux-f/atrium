...
particle minecraft:reverse_portal ~ ~ ~ 0.1 0.25 0.1 0.1 40 force
playsound atrium:favor.chorus neutral @a[distance=..10] ~ ~ ~ 1 1 0.1
...
execute if entity @s[scores={chorus_favor=1..9}] run effect give @s minecraft:night_vision 600 0
...
execute if entity @s[scores={chorus_favor=10..19}] run effect give @s minecraft:night_vision 1200 0
...
execute if entity @s[scores={chorus_favor=20..29}] run effect give @s minecraft:night_vision 2400 0
