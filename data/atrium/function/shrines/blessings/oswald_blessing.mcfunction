...
execute if entity @s[scores={oswald_favor=1}] run tellraw @s ["",{"text":"\u06e9 ","color":"gray"},{"text":"You breathe in... the scent of flowers and fresh bread surrounds you.","italic":true,"color":"gray"},{"text":" \u06e9","color":"gray"}]
...
execute if entity @s[scores={oswald_favor=10}] run tellraw @s ["",{"text":"\u06e9 ","color":"gray"},{"text":"You brush your hand against the shrine, the course fibers of the roots running through your fingers.","italic":true,"color":"gray"},{"text":" \u06e9","color":"gray"}]
...
execute if entity @s[scores={oswald_favor=20}] run tellraw @s ["",{"text":"\u06e9 ","color":"gray"},{"text":"You can almost hear a faint, quiet humming. The Peasant God watches over you, in his own small way.","italic":true,"color":"gray"},{"text":" \u06e9","color":"gray"}]
...
execute if entity @s[scores={oswald_favor=30}] run tellraw @s ["",{"text":"\u06e9 ","color":"gray"},{"text":"Small roots have crept across your arm without you noticing. The lifeblood of the creator flows through you.","italic":true,"color":"gray"},{"text":" \u06e9","color":"gray"}]
