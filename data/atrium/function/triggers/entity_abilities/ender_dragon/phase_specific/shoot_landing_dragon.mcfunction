...
execute in minecraft:the_end if predicate atrium:percentage_chances/0.50_p run summon area_effect_cloud 0 63 0 {custom_particle:{type:"minecraft:portal"},CustomNameVisible:0b,Radius:0.1f,RadiusPerTick:0f,RadiusOnUse:0f,Duration:600,Tags:["atrium_dragon_ward_timer"],CustomName:{text:"Spacial Distortion Ward Timer","color":"dark_purple","italic":false}}
#
# Start Ward
