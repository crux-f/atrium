...
execute at @s as @a[distance=..1000,nbt={Inventory:[{Slot:-106b,components:{"minecraft:custom_data":{atrium_guild_almanac:1b}}}]}] run function atrium:misc/xp_calculators/bonus/extra_xp_from_items