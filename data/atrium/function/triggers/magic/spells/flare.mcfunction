# Creates a light!
execute if data entity @s {equipment:{offhand:{components:{"minecraft:custom_data":{atrium_staff_lv:2b}}}}} positioned ~ ~3 ~ if block ~ ~ ~ minecraft:air run summon minecraft:marker ~ ~ ~ {Tags:["atrium_special","atrium_temporary_entity","atrium_temporary_block","atrium_flare_spell","atrium_particle"],data:{Level:1}}
execute if data entity @s {equipment:{offhand:{components:{"minecraft:custom_data":{atrium_staff_lv:3b}}}}} positioned ~ ~3 ~ if block ~ ~ ~ minecraft:air run summon minecraft:marker ~ ~ ~ {Tags:["atrium_special","atrium_temporary_entity","atrium_temporary_block","atrium_flare_spell","atrium_particle"],data:{Level:2}}
#
# Fail Particles
...
execute if data entity @s {equipment:{offhand:{components:{"minecraft:custom_data":{atrium_staff_lv:2b}}}}} run scoreboard players set @e[tag=atrium_flare_spell,distance=..5] charge -2400
execute if data entity @s {equipment:{offhand:{components:{"minecraft:custom_data":{atrium_staff_lv:3b}}}}} run scoreboard players set @e[tag=atrium_flare_spell,distance=..5] charge -6000
#
