...
# Summon return point
# execute as @e[tag=atrium_parallax_target] at @s run summon area_effect_cloud ~ ~ ~ {custom_particle:"smoke",CustomNameVisible:0b,Radius:0f,Duration:120,Tags:["atrium_parallax_return"],Potion:"minecraft:empty",CustomName:{text:"Return Point"}}
# Target particles
