...
execute at @s[nbt={Inventory:[{Slot:-106b,tag:{atrium_staff_lv:2b}}]}] as @e[tag=atrium_inhale_target,distance=..25] store result entity @s Motion[0] double -0.02 run scoreboard players get @s atrium_x_coordinate
execute at @s[nbt={Inventory:[{Slot:-106b,tag:{atrium_staff_lv:2b}}]}] as @e[tag=atrium_inhale_target,distance=..25] store result entity @s Motion[1] double -0.02 run scoreboard players get @s atrium_y_coordinate
execute at @s[nbt={Inventory:[{Slot:-106b,tag:{atrium_staff_lv:2b}}]}] as @e[tag=atrium_inhale_target,distance=..25] store result entity @s Motion[2] double -0.02 run scoreboard players get @s atrium_z_coordinate
# Spell Level 2 (Staff Lv 3) = Set the target's Motion to 5% of the resulting difference
execute at @s[nbt={Inventory:[{Slot:-106b,tag:{atrium_staff_lv:3b}}]}] as @e[tag=atrium_inhale_target,distance=..25] store result entity @s Motion[0] double -0.05 run scoreboard players get @s atrium_x_coordinate
execute at @s[nbt={Inventory:[{Slot:-106b,tag:{atrium_staff_lv:3b}}]}] as @e[tag=atrium_inhale_target,distance=..25] store result entity @s Motion[1] double -0.05 run scoreboard players get @s atrium_y_coordinate
execute at @s[nbt={Inventory:[{Slot:-106b,tag:{atrium_staff_lv:3b}}]}] as @e[tag=atrium_inhale_target,distance=..25] store result entity @s Motion[2] double -0.05 run scoreboard players get @s atrium_z_coordinate
#
