...
execute if data entity @s {Inventory:[{Slot:-106b,components:{"minecraft:custom_data":{atrium_staff_lv:1b}}}]} run summon area_effect_cloud ~ ~ ~ {CustomName: '{"text":"Time Sigil I"}', CustomNameVisible: 0b, Duration: 240, Particle: {type: "minecraft:portal"}, Radius: 1.0f, Tags: ["atrium_time_sigil"], potion_contents: {potion: "minecraft:empty"}}
execute if data entity @s {Inventory:[{Slot:-106b,components:{"minecraft:custom_data":{atrium_staff_lv:2b}}}]} run summon area_effect_cloud ~ ~ ~ {CustomName: '{"text":"Time Sigil II"}', CustomNameVisible: 0b, Duration: 240, Particle: {type: "minecraft:portal"}, Radius: 2.0f, Tags: ["atrium_time_sigil"], potion_contents: {potion: "minecraft:empty"}}
execute if data entity @s {Inventory:[{Slot:-106b,components:{"minecraft:custom_data":{atrium_staff_lv:3b}}}]} run summon area_effect_cloud ~ ~ ~ {CustomName: '{"text":"Time Sigil III"}', CustomNameVisible: 0b, Duration: 240, Particle: {type: "minecraft:portal"}, Radius: 3.0f, Tags: ["atrium_time_sigil"], potion_contents: {potion: "minecraft:empty"}}
