...
execute if data entity @s {Inventory:[{Slot:-106b,components:{"minecraft:custom_data":{atrium_staff_lv:1b}}}]} run summon area_effect_cloud ~ ~10 ~ {Duration: 1200, Particle: {type: "minecraft:cloud"}, Radius: 3.0f}
execute if data entity @s {Inventory:[{Slot:-106b,components:{"minecraft:custom_data":{atrium_staff_lv:2b}}}]} run summon area_effect_cloud ~ ~10 ~ {Duration: 2380, Particle: {type: "minecraft:rain"}, Radius: 3.0f}
execute if data entity @s {Inventory:[{Slot:-106b,components:{"minecraft:custom_data":{atrium_staff_lv:2b}}}]} run summon area_effect_cloud ~ ~10 ~ {Duration: 2400, Particle: {type: "minecraft:cloud"}, Radius: 3.0f}
execute if data entity @s {Inventory:[{Slot:-106b,components:{"minecraft:custom_data":{atrium_staff_lv:3b}}}]} run summon area_effect_cloud ~ ~10 ~ {Duration: 5980, Particle: {type: "minecraft:rain"}, Radius: 3.0f}
execute if data entity @s {Inventory:[{Slot:-106b,components:{"minecraft:custom_data":{atrium_staff_lv:3b}}}]} run summon area_effect_cloud ~ ~10 ~ {Duration: 6000, Particle: {type: "minecraft:cloud"}, Radius: 3.0f}
#
