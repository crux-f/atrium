...
execute as @e[tag=song_spell_13,scores={charge=177..}] run function atrium:triggers/magic/spells/song/revert_song_disc_to_normal
...
execute if entity @e[tag=song_spell_13] run schedule function atrium:triggers/magic/spells/song/ss_13 1s