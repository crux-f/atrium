...
execute as @e[tag=song_spell_otherside,scores={charge=195..}] run function atrium:triggers/magic/spells/song/revert_song_disc_to_normal
...
execute if entity @e[tag=song_spell_otherside] run schedule function atrium:triggers/magic/spells/song/ss_otherside 1s