...
execute as @e[tag=song_spell_wait,scores={charge=234..}] run function atrium:triggers/magic/spells/song/revert_song_disc_to_normal
...
execute if entity @e[tag=song_spell_wait] run schedule function atrium:triggers/magic/spells/song/ss_wait 1s