...
execute as @e[tag=song_spell_11,scores={charge=71..}] run function atrium:triggers/magic/spells/song/revert_song_disc_to_normal
...
execute if entity @e[tag=song_spell_11] run schedule function atrium:triggers/magic/spells/song/ss_11 1s