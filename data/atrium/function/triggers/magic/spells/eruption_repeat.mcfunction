...
execute as @e[tag=atrium_eruption_spell] at @s if entity @s[scores={charge=-1120..}] if predicate atrium:percentage_chances/0.08_p at @e[distance=..6,type=!#atrium:inanimate_entities] run summon small_fireball ~ ~5 ~ {Motion:[0.0,-10.0,0.0]}
#
