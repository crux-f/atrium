...
execute positioned ^ ^ ^2.5 as @p[predicate=atrium:player/targetable_and_visible,tag=!atrium_fizzle_spell_caster,distance=..15,nbt={equipment:{offhand:{components:{"minecraft:custom_data":{atrium_staff:1b}}}}}] run function atrium:triggers/magic/spells/fizzle_spell/counter_staff_player
