...
execute if data entity @s {equipment:{offhand:{components:{"minecraft:custom_data":{atrium_staff_lv:1b}}}}} run summon area_effect_cloud ~ ~ ~ {CustomName: {text:"Earth Sigil I"}, Duration: 240, custom_particle: {type: "minecraft:mycelium"}, Radius: 1.0f, Tags: ["atrium_earth_sigil"], potion_contents: {custom_effects: [{amplifier: 0b, duration: 2400, id: "minecraft:haste", show_particles: 1b}]}}
execute if data entity @s {equipment:{offhand:{components:{"minecraft:custom_data":{atrium_staff_lv:2b}}}}} run summon area_effect_cloud ~ ~ ~ {CustomName: {text:"Earth Sigil II"}, Duration: 480, custom_particle: {type: "minecraft:mycelium"}, Radius: 2.0f, Tags: ["atrium_earth_sigil"], potion_contents: {custom_effects: [{amplifier: 0b, duration: 4800, id: "minecraft:haste", show_particles: 1b}]}}
execute if data entity @s {equipment:{offhand:{components:{"minecraft:custom_data":{atrium_staff_lv:3b}}}}} run summon area_effect_cloud ~ ~ ~ {CustomName: {text:"Earth Sigil III"}, Duration: 720, custom_particle: {type: "minecraft:mycelium"}, Radius: 3.0f, Tags: ["atrium_earth_sigil"], potion_contents: {custom_effects: [{amplifier: 1b, duration: 9600, id: "minecraft:haste", show_particles: 1b}]}}
#
