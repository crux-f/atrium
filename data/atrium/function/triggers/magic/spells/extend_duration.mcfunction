...
execute if entity @s[tag=atrium_extend_next_potion] if data entity @s {Inventory:[{Slot:-106b,components:{"minecraft:custom_data":{atrium_staff_lv:3b}}}]} run tag @s add atrium_extend_next_powerful_potion
#
#
# Spell cleanup
