...
execute if predicate atrium:entity/is_in_water if block ~ ~-1 ~ minecraft:water if data entity @s {equipment:{offhand:{components:{"minecraft:custom_data":{atrium_staff_lv:3b}}}}} run effect give @s dolphins_grace 10 0 false
