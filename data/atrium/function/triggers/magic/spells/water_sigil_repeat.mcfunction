# Particle animation
execute at @e[tag=atrium_water_sigil_dummy] run particle dust{color:[0.000,0.600,0.400],scale:1} ^1.25 ^0.5 ^ 0 0 0 1 1 normal
execute at @e[tag=atrium_water_sigil_dummy] run particle dust{color:[0.000,0.600,0.400],scale:1} ^-1.25 ^0.5 ^ 0 0 0 1 1 normal
execute at @e[tag=atrium_water_sigil_dummy] run particle dust{color:[0.000,0.600,0.400],scale:1} ^ ^0.5 ^1.25 0 0 0 1 1 normal
execute at @e[tag=atrium_water_sigil_dummy] run particle dust{color:[0.000,0.600,0.400],scale:1} ^ ^0.5 ^-1.25 0 0 0 1 1 normal
