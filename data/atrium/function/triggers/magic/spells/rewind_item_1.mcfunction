...
execute as @a[tag=atrium_rewind_item_caster] at @s if data entity @s {SelectedItem:{components:{"minecraft:enchantments":{levels:{"minecraft:vanishing_curse":5}}}}} run function atrium:triggers/magic/spell_failure_effects
execute as @a[tag=atrium_rewind_item_caster] at @s if data entity @s {SelectedItem:{components:{"minecraft:enchantments":{levels:{"minecraft:vanishing_curse":5}}}}} run tellraw @s {"text":"(Even miracles only go so far.)","italic":true,"color":"gray"}
...
execute as @a[tag=atrium_rewind_item_caster] run item modify entity @s weapon.mainhand atrium:rewind_item/rewind_1_r4
# If it has been rewound 2 times, repair 60% of its durability.
execute as @a[tag=atrium_rewind_item_caster] run item modify entity @s weapon.mainhand atrium:rewind_item/rewind_1_r3
# If it has been rewound 1 time, repair 80% of its durability.
execute as @a[tag=atrium_rewind_item_caster] run item modify entity @s weapon.mainhand atrium:rewind_item/rewind_1_r2
