...
execute at @e[tag=atrium_catalyze_target] run particle dust_color_transition{from_color:[1.031,0.000,1.000],scale:1,to_color:[1.000,1.000,0.000]} ~ ~ ~ 0.5 0.5 0.5 0.1 50 normal
