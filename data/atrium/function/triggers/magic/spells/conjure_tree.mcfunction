...
#
execute if entity @s[nbt={equipment:{offhand:{components:{"minecraft:custom_data":{atrium_staff_lv:3b}}}}}] run tag @e[tag=atrium_conjured_tree_root,distance=..10] add atrium_longer_duration
