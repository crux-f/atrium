...
# top + bottom
execute if entity @s[nbt={equipment:{offhand:{components:{"minecraft:custom_data":{atrium_staff_lv:3b}}}}}] anchored eyes positioned ^ ^2 ^3 if block ~ ~ ~ minecraft:air run summon minecraft:marker ~ ~ ~ {Tags:["atrium_special","atrium_temporary_block","atrium_temporary_entity","atrium_arcane_ward","atrium_particle","atrium_portal_aura"]}
execute if entity @s[nbt={equipment:{offhand:{components:{"minecraft:custom_data":{atrium_staff_lv:3b}}}}}] anchored eyes positioned ^ ^-2 ^3 if block ~ ~ ~ minecraft:air run summon minecraft:marker ~ ~ ~ {Tags:["atrium_special","atrium_temporary_block","atrium_temporary_entity","atrium_arcane_ward","atrium_particle","atrium_portal_aura"]}
execute if entity @s[nbt={equipment:{offhand:{components:{"minecraft:custom_data":{atrium_staff_lv:3b}}}}}] anchored eyes positioned ^1 ^2 ^3 if block ~ ~ ~ minecraft:air run summon minecraft:marker ~ ~ ~ {Tags:["atrium_special","atrium_temporary_block","atrium_temporary_entity","atrium_arcane_ward","atrium_particle","atrium_portal_aura"]}
execute if entity @s[nbt={equipment:{offhand:{components:{"minecraft:custom_data":{atrium_staff_lv:3b}}}}}] anchored eyes positioned ^1 ^-2 ^3 if block ~ ~ ~ minecraft:air run summon minecraft:marker ~ ~ ~ {Tags:["atrium_special","atrium_temporary_block","atrium_temporary_entity","atrium_arcane_ward","atrium_particle","atrium_portal_aura"]}
execute if entity @s[nbt={equipment:{offhand:{components:{"minecraft:custom_data":{atrium_staff_lv:3b}}}}}] anchored eyes positioned ^-1 ^2 ^3 if block ~ ~ ~ minecraft:air run summon minecraft:marker ~ ~ ~ {Tags:["atrium_special","atrium_temporary_block","atrium_temporary_entity","atrium_arcane_ward","atrium_particle","atrium_portal_aura"]}
execute if entity @s[nbt={equipment:{offhand:{components:{"minecraft:custom_data":{atrium_staff_lv:3b}}}}}] anchored eyes positioned ^-1 ^-2 ^3 if block ~ ~ ~ minecraft:air run summon minecraft:marker ~ ~ ~ {Tags:["atrium_special","atrium_temporary_block","atrium_temporary_entity","atrium_arcane_ward","atrium_particle","atrium_portal_aura"]}
# sides
execute if entity @s[nbt={equipment:{offhand:{components:{"minecraft:custom_data":{atrium_staff_lv:3b}}}}}] anchored eyes positioned ^2 ^ ^3 if block ~ ~ ~ minecraft:air run summon minecraft:marker ~ ~ ~ {Tags:["atrium_special","atrium_temporary_block","atrium_temporary_entity","atrium_arcane_ward","atrium_particle","atrium_portal_aura"]}
execute if entity @s[nbt={equipment:{offhand:{components:{"minecraft:custom_data":{atrium_staff_lv:3b}}}}}] anchored eyes positioned ^-2 ^ ^3 if block ~ ~ ~ minecraft:air run summon minecraft:marker ~ ~ ~ {Tags:["atrium_special","atrium_temporary_block","atrium_temporary_entity","atrium_arcane_ward","atrium_particle","atrium_portal_aura"]}
execute if entity @s[nbt={equipment:{offhand:{components:{"minecraft:custom_data":{atrium_staff_lv:3b}}}}}] anchored eyes positioned ^2 ^1 ^3 if block ~ ~ ~ minecraft:air run summon minecraft:marker ~ ~ ~ {Tags:["atrium_special","atrium_temporary_block","atrium_temporary_entity","atrium_arcane_ward","atrium_particle","atrium_portal_aura"]}
execute if entity @s[nbt={equipment:{offhand:{components:{"minecraft:custom_data":{atrium_staff_lv:3b}}}}}] anchored eyes positioned ^-2 ^1 ^3 if block ~ ~ ~ minecraft:air run summon minecraft:marker ~ ~ ~ {Tags:["atrium_special","atrium_temporary_block","atrium_temporary_entity","atrium_arcane_ward","atrium_particle","atrium_portal_aura"]}
execute if entity @s[nbt={equipment:{offhand:{components:{"minecraft:custom_data":{atrium_staff_lv:3b}}}}}] anchored eyes positioned ^2 ^-1 ^3 if block ~ ~ ~ minecraft:air run summon minecraft:marker ~ ~ ~ {Tags:["atrium_special","atrium_temporary_block","atrium_temporary_entity","atrium_arcane_ward","atrium_particle","atrium_portal_aura"]}
execute if entity @s[nbt={equipment:{offhand:{components:{"minecraft:custom_data":{atrium_staff_lv:3b}}}}}] anchored eyes positioned ^-2 ^-1 ^3 if block ~ ~ ~ minecraft:air run summon minecraft:marker ~ ~ ~ {Tags:["atrium_special","atrium_temporary_block","atrium_temporary_entity","atrium_arcane_ward","atrium_particle","atrium_portal_aura"]}
# corners
execute if entity @s[nbt={equipment:{offhand:{components:{"minecraft:custom_data":{atrium_staff_lv:3b}}}}}] anchored eyes positioned ^2 ^2 ^3 if block ~ ~ ~ minecraft:air run summon minecraft:marker ~ ~ ~ {Tags:["atrium_special","atrium_temporary_block","atrium_temporary_entity","atrium_arcane_ward","atrium_particle","atrium_portal_aura"]}
execute if entity @s[nbt={equipment:{offhand:{components:{"minecraft:custom_data":{atrium_staff_lv:3b}}}}}] anchored eyes positioned ^-2 ^2 ^3 if block ~ ~ ~ minecraft:air run summon minecraft:marker ~ ~ ~ {Tags:["atrium_special","atrium_temporary_block","atrium_temporary_entity","atrium_arcane_ward","atrium_particle","atrium_portal_aura"]}
execute if entity @s[nbt={equipment:{offhand:{components:{"minecraft:custom_data":{atrium_staff_lv:3b}}}}}] anchored eyes positioned ^2 ^-2 ^3 if block ~ ~ ~ minecraft:air run summon minecraft:marker ~ ~ ~ {Tags:["atrium_special","atrium_temporary_block","atrium_temporary_entity","atrium_arcane_ward","atrium_particle","atrium_portal_aura"]}
execute if entity @s[nbt={equipment:{offhand:{components:{"minecraft:custom_data":{atrium_staff_lv:3b}}}}}] anchored eyes positioned ^-2 ^-2 ^3 if block ~ ~ ~ minecraft:air run summon minecraft:marker ~ ~ ~ {Tags:["atrium_special","atrium_temporary_block","atrium_temporary_entity","atrium_arcane_ward","atrium_particle","atrium_portal_aura"]}
#
...
execute if entity @s[nbt={equipment:{offhand:{components:{"minecraft:custom_data":{atrium_staff_lv:2b}}}}}] as @e[tag=atrium_arcane_ward,distance=..10] run scoreboard players set @s charge -200
execute if entity @s[nbt={equipment:{offhand:{components:{"minecraft:custom_data":{atrium_staff_lv:3b}}}}}] as @e[tag=atrium_arcane_ward,distance=..10] run scoreboard players set @s charge -400
#
