# Particle animation
execute at @e[tag=atrium_earth_sigil_dummy] run particle minecraft:falling_dust{block_state:"minecraft:gravel"} ^1 ^ ^ 0 0 0 0 1 normal
execute at @e[tag=atrium_earth_sigil_dummy] run particle minecraft:falling_dust{block_state:"minecraft:gravel"} ^-1 ^ ^ 0 0 0 0 1 normal
execute at @e[tag=atrium_earth_sigil_dummy] run particle minecraft:falling_dust{block_state:"minecraft:gravel"} ^ ^ ^1 0 0 0 0 1 normal
execute at @e[tag=atrium_earth_sigil_dummy] run particle minecraft:falling_dust{block_state:"minecraft:gravel"} ^ ^ ^-1 0 0 0 0 1 normal
...
execute at @e[tag=atrium_earth_sigil_dummy_s] run particle minecraft:falling_dust{block_state:"minecraft:dirt"} ^0.25 ^ ^ 0 0 0 0 1 normal
execute at @e[tag=atrium_earth_sigil_dummy_s] run particle minecraft:falling_dust{block_state:"minecraft:dirt"} ^-0.25 ^ ^ 0 0 0 0 1 normal
execute at @e[tag=atrium_earth_sigil_dummy_s] run particle minecraft:falling_dust{block_state:"minecraft:dirt"} ^ ^ ^0.25 0 0 0 0 1 normal
execute at @e[tag=atrium_earth_sigil_dummy_s] run particle minecraft:falling_dust{block_state:"minecraft:dirt"} ^ ^ ^-0.25 0 0 0 0 1 normal
execute at @e[tag=atrium_earth_sigil_dummy_s] run particle minecraft:falling_dust{block_state:"minecraft:gravel"} ^2.75 ^ ^ 0 0 0 0 1 normal
execute at @e[tag=atrium_earth_sigil_dummy_s] run particle minecraft:falling_dust{block_state:"minecraft:gravel"} ^-2.75 ^ ^ 0 0 0 0 1 normal
execute at @e[tag=atrium_earth_sigil_dummy_s] run particle minecraft:falling_dust{block_state:"minecraft:gravel"} ^ ^ ^2.75 0 0 0 0 1 normal
execute at @e[tag=atrium_earth_sigil_dummy_s] run particle minecraft:falling_dust{block_state:"minecraft:gravel"} ^ ^ ^-2.75 0 0 0 0 1 normal
