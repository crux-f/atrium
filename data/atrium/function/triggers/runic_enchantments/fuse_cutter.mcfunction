...
# TNT is defused
execute at @s positioned ^ ^ ^3 as @e[limit=1,type=minecraft:tnt,distance=..3,sort=nearest] if entity @s at @s run summon item ~ ~ ~ {Item:{id:"minecraft:tnt",count:1}}
...
execute at @s positioned ^ ^ ^3 as @e[limit=1,type=minecraft:tnt_minecart,distance=..3,sort=nearest] if entity @s at @s run summon item ~ ~ ~ {Item:{id:"minecraft:tnt_minecart",count:1}}
