...
execute at @s positioned ^ ^ ^1.5 as @e[limit=1,tag=atrium_installing_core,sort=nearest,distance=..5] run data merge entity @s {HandItems:[{id:"minecraft:iron_ingot",count:1,components:{"minecraft:item_name":{text:"Holy Core Attack"},"minecraft:rarity":"uncommon","minecraft:enchantments":{"minecraft:smite":2}}},{}],HandDropChances:[-327.67F,0.085F]}
