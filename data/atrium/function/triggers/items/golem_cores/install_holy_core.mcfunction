...
execute at @s positioned ^ ^ ^1.5 as @e[limit=1,type=minecraft:iron_golem,sort=nearest,distance=..5] if entity @s[tag=atrium_golem_core_installed] run give @p[gamemode=!spectator] minecraft:iron_ingot[minecraft:custom_model_data={strings:["atrium_golem_core_holy"]},minecraft:lore=['{"text":"Holy","color":"yellow","italic":false}','{"text":" "}','{"text":"When Used on Damaged Iron Golem:","color":"dark_purple","italic":false}','{"text":"Smite II","color":"gray","italic":false}'],minecraft:item_name='{"text":"Golem Core"}',minecraft:custom_data={atrium_core_type:"holy",atrium_golem_core:1b}] 1
...
execute at @s positioned ^ ^ ^1.5 as @e[limit=1,tag=atrium_installing_core,sort=nearest,distance=..5] run data merge entity @s {HandItems:[{id:"minecraft:iron_ingot",count:1,components:{"minecraft:item_name":'{"text":"Holy Core Attack"}',"minecraft:rarity":"uncommon","minecraft:enchantments":{levels:{"minecraft:smite":2}}}},{}],HandDropChances:[0.000F,0.085F]}
