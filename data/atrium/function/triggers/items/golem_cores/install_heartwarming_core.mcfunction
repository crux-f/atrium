...
execute at @s positioned ^ ^ ^1.5 as @e[limit=1,tag=atrium_installing_core,sort=nearest,distance=..5] run data modify entity @s ArmorItems[0] set value {id:"minecraft:leather_boots",count:1,components:{"minecraft:unreakable":{}}}
