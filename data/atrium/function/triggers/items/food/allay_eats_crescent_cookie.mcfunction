...
execute as @e[type=minecraft:allay,nbt={HandItems:[{components:{"minecraft:custom_data":{atrium_crescent_cookie:1b}}}]}] at @s at @s run particle minecraft:item{item:{id:"minecraft:cookie",components:{"minecraft:custom_model_data":333201}}} ~ ~ ~ 0.25 0.25 0.25 0 5 normal
