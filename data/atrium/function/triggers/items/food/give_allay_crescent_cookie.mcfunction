...
execute at @s as @e[type=minecraft:allay,sort=nearest,limit=1,nbt={HandItems:[{components:{"minecraft:custom_data":{atrium_crescent_cookie:1b}}}]}] at @s run particle minecraft:item{item:{id:"minecraft:cookie",components:{"minecraft:custom_model_data":333201}}} ~ ~ ~ 0.25 0.25 0.25 0 5 normal
#
