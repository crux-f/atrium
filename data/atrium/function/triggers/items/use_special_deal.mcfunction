...
#
execute at @s as @e[limit=1,tag=atrium_signing_agreement,sort=nearest,distance=..5,type=minecraft:wandering_trader] if data entity @s {Inventory:[{components:{"minecraft:custom_data":{atrium_buy_1_mending_book:1}}}]} run data modify entity @s Offers.Recipes append value {rewardExp:1b,maxUses:1,xp:0,priceMultiplier:0.05f,buy:{id:"minecraft:emerald",count:48b},sell:{id:"minecraft:enchanted_book",count:1b,components:{"minecraft:lore":['{"text":"This precious tome contains"}','{"text":"a story of death and rebirth."}','{"text":"Its magic is very rare,"}','{"text":"and it is considered a"}','{"text":"great treasure."}'],"minecraft:stored_enchantments":{levels:{"minecraft:mending":1}},"minecraft:rarity":"rare","minecraft:custom_data":{atrium_mending_storybook:1b}}}}
execute at @s as @e[limit=1,tag=atrium_signing_agreement,sort=nearest,distance=..5,type=minecraft:wandering_trader] if data entity @s {Inventory:[{components:{"minecraft:custom_data":{atrium_buy_1_heart_of_the_sea:1}}}]} run data modify entity @s Offers.Recipes append value {rewardExp:1b,maxUses:1,xp:0,priceMultiplier:0.05f,buy:{id:"minecraft:emerald",count:24b},sell:{id:"minecraft:heart_of_the_sea",count:1b}}
...
execute at @s as @e[limit=1,tag=atrium_signing_agreement,sort=nearest,distance=..5,type=minecraft:wandering_trader] if data entity @s {Inventory:[{components:{"minecraft:custom_data":{atrium_buy_1_totem_of_undying:1}}}]} run data modify entity @s Offers.Recipes append value {rewardExp:1b,maxUses:1,xp:0,priceMultiplier:0.05f,buy:{id:"minecraft:emerald",count:32b},sell:{id:"minecraft:totem_of_undying",count:1b}}
