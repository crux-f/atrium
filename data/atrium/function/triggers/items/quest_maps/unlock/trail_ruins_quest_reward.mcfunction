...
advancement revoke @s only atrium:triggers/items/quest_maps/trail_ruins_quest_complete
# Tag player
tag @s add atrium_getting_trail_ruins_reward
# Remove key in 1 tick (allows for loot table to have a chance to run before the key is removed)
schedule function atrium:triggers/items/quest_maps/take_map/trail_ruins_quest 1t
