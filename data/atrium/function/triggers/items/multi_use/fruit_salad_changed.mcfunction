...
execute as @a[tag=atrium_eating_fruit_salad] if entity @s[nbt={equipment:{offhand:{id:"minecraft:bowl",count:1}}}] run function atrium:items/slot_control/clear_offhand_item
#
