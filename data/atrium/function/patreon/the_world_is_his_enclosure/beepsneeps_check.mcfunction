...
schedule function atrium:patreon/the_world_is_his_enclosure/beepsneeps_check 10s
#
# If it is dusk, choose a random player to be the Victim.
execute if predicate atrium:time_check/is_dusk unless entity @a[scores={atrium_beepsneeps_anomaly=1..}] as @r[gamemode=survival] at @s run function atrium:patreon/the_world_is_his_enclosure/unleash_beepsneeps
#
