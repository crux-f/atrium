...
scoreboard objectives add resurrect dummy
...
scoreboard objectives add dream_return_z dummy
scoreboard objectives add raid_wins minecraft.custom:minecraft.raid_win
scoreboard objectives add illager_player_bounty_timer minecraft.custom:minecraft.play_time
scoreboard objectives add illager_bounty_level dummy
scoreboard objectives add taunt_timer dummy
...
scoreboard objectives add hush_spell dummy
# Enchantments
