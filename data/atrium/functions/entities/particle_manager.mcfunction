...
execute at @s[tag=atrium_terror_aura] run particle dust 0.180 1.000 0.235 2 ~ ~ ~ 0.5 0.5 0.5 0.5 10 normal
...
execute at @s[tag=atrium_dust_sometimes] if predicate atrium:percentage_chances/0.15_p run particle minecraft:falling_dust minecraft:stone ~ ~ ~ 0.5 0.75 0.5 0.01 1 normal
