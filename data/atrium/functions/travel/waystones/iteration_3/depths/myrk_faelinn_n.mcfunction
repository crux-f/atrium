...
execute as @p[gamemode=!spectator] in atrium:depths run tp @s 35944.5 712 -4053.5
execute in atrium:depths positioned 35944.5 712 -4053.5 run particle minecraft:flash ~ ~1 ~ 0 0 0 1 30
execute in atrium:depths positioned 35944.5 712 -4053.5 run playsound minecraft:entity.enderman.teleport master @a[distance=..30] ~ ~ ~ 1 1 0.1
