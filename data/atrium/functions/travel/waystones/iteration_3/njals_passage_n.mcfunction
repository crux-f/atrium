...
execute as @p[gamemode=!spectator] in minecraft:overworld run tp @s 35433.5 124 -2019.5
execute in minecraft:overworld positioned 35433.5 124 -2019.5 run particle minecraft:flash ~ ~1 ~ 0 0 0 1 30
execute in minecraft:overworld positioned 35433.5 124 -2019.5 run playsound minecraft:entity.enderman.teleport master @a[distance=..30] ~ ~ ~ 1 1 0.1
