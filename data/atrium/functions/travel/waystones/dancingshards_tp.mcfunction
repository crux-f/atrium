...
execute as @p[gamemode=!spectator] in atrium:meridian run tp @s 3562.5 186 -5750.5
execute in atrium:meridian positioned -269.5 45 194.5 run particle minecraft:flash ~ ~1 ~ 0 0 0 1 30
execute in atrium:meridian positioned -269.5 45 194.5 run playsound minecraft:entity.enderman.teleport master @a[distance=..30] ~ ~ ~ 1 1 0.1
