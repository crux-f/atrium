...
execute as @p[gamemode=!spectator] in atrium:depths run tp @s 9104.5 53 -9231.5
execute in atrium:depths positioned 9104.5 53 -9231.5 run particle minecraft:flash ~ ~1 ~ 0 0 0 1 30
execute in atrium:depths positioned 9104.5 53 -9231.5 run playsound minecraft:entity.enderman.teleport master @a[distance=..30] ~ ~ ~ 1 1 0.1
