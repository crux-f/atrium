...
execute as @p[gamemode=!spectator] in minecraft:the_nether run tp @s 549.5 91 243.5
execute in minecraft:the_nether positioned 549.5 91 243.5 run particle minecraft:flash ~ ~1 ~ 0 0 0 1 30
execute in minecraft:the_nether positioned 549.5 91 243.5 run playsound minecraft:entity.enderman.teleport master @a[distance=..30] ~ ~ ~ 1 1 0.1
