...
execute as @p[gamemode=!spectator] in minecraft:overworld run tp @p[gamemode=!spectator] -3183.5 61 -1602.5
execute in minecraft:overworld positioned -3183.5 61 -1602.5 run particle minecraft:flash ~ ~1 ~ 0 0 0 1 30
execute in minecraft:overworld positioned -3183.5 61 -1602.5 run playsound minecraft:entity.enderman.teleport master @a[distance=..30] ~ ~ ~ 1 1 0.1
