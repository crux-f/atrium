...
#
# Teleport!
execute in atrium:depths at @e[tag=fx_travel] positioned ~-6 ~2 ~ as @e[distance=..1,type=!item_frame,type=!marker,tag=!warping] at @s run function atrium:travel/warp_gate/summon_warp_gate_hook
#
