...
xp add @a[gamemode=!spectator,nbt={Inventory:[{Slot:-106b,tag:{timestaff:1b,lv1:1b}}]}] -5 points
xp add @a[gamemode=!spectator,nbt={Inventory:[{Slot:-106b,tag:{timestaff:1b,lv2:1b}}]}] -10 points
xp add @a[gamemode=!spectator,nbt={Inventory:[{Slot:-106b,tag:{timestaff:1b,lv3:1b}}]}] -15 points
