...
execute if entity @a[predicate=atrium:desync_1_req] as @a[predicate=atrium:desync_1_req] run function atrium:magic/magicitems/spells/desync_1
execute if entity @a[predicate=atrium:lethargysigil_1_req] as @a[predicate=atrium:lethargysigil_1_req] run function atrium:magic/magicitems/spells/lethargysigil_1_start
