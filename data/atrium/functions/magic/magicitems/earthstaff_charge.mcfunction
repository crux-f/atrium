...
# 
#
scoreboard players add @a[gamemode=!spectator,nbt={Inventory:[{Slot:-106b,tag:{earthstaff:1b,lv1:1b}}]},level=2..] earthstaff 1
...
xp add @a[gamemode=!spectator,nbt={Inventory:[{Slot:-106b,tag:{earthstaff:1b,lv1:1b}}]}] -5 points
xp add @a[gamemode=!spectator,nbt={Inventory:[{Slot:-106b,tag:{earthstaff:1b,lv2:1b}}]}] -10 points
xp add @a[gamemode=!spectator,nbt={Inventory:[{Slot:-106b,tag:{earthstaff:1b,lv3:1b}}]}] -15 points
...
execute if entity @a[predicate=atrium:stone_sprite_1_req] run function atrium:magic/magicitems/spells/stone_sprite_1
