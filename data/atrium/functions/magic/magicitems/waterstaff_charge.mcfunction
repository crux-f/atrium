...
execute if entity @a[predicate=atrium:extinguish_1_req] as @a[predicate=atrium:extinguish_1_req] run function atrium:magic/magicitems/spells/extinguish_1
execute if entity @a[predicate=atrium:nourishment_1_req] as @a[predicate=atrium:nourishment_1_req] run function atrium:magic/magicitems/spells/nourishment_1_start
execute if entity @a[predicate=atrium:extinguish_2_req] as @a[predicate=atrium:extinguish_2_req] run function atrium:magic/magicitems/spells/extinguish_2
execute if entity @a[predicate=atrium:nourishment_2_req] as @a[predicate=atrium:nourishment_2_req] run function atrium:magic/magicitems/spells/nourishment_2_start
