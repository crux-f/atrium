...
execute as @a[predicate=atrium:updraft_1_req] at @s run summon area_effect_cloud ~ ~ ~ {Particle:"cloud",Radius:1f,Duration:240,Tags:["updraft"],Potion:"minecraft:empty",Effects:[{Id:25b,Amplifier:3b,Duration:40,ShowParticles:0b}],CustomName:'{"text":"Updraft"}'}
