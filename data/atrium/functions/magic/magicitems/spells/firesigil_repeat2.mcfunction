execute at @e[tag=fx_firesigil] run particle flame ^0.85 ^ ^ 0 0 0 0 1 normal
execute at @e[tag=fx_firesigil] run particle flame ^-0.85 ^ ^ 0 0 0 0 1 normal
execute at @e[tag=fx_firesigil] run particle flame ^ ^ ^0.85 0 0 0 0 1 normal
execute at @e[tag=fx_firesigil] run particle flame ^ ^ ^-0.85 0 0 0 0 1 normal
execute at @e[tag=fx_firesigil] run particle flame ^2 ^ ^ 0 0 0 0 1 normal
execute at @e[tag=fx_firesigil] run particle flame ^-2 ^ ^ 0 0 0 0 1 normal
execute at @e[tag=fx_firesigil] run particle flame ^ ^ ^2 0 0 0 0 1 normal
execute at @e[tag=fx_firesigil] run particle flame ^ ^ ^-2 0 0 0 0 1 normal
execute as @e[tag=fx_firesigil] at @s run tp @s ~ ~ ~ ~-2 ~0
execute if entity @e[tag=firesigil,nbt={Age:239}] at @e[tag=fx_firesigil] run particle minecraft:lava ~ ~ ~ 1.5 1.5 1.5 0.1 100
...
execute if entity @e[tag=firesigil,nbt={Age:239}] at @e[tag=fx_firesigil] run summon small_fireball ~ ~2 ~-1 {direction:[0.0,-10.0,0.0],power:[0.0,-10.0,0.0]}
#
execute if entity @e[tag=firesigil,nbt={Age:239}] at @e[tag=fx_firesigil] run summon small_fireball ~1 ~2 ~1 {direction:[0.0,-10.0,0.0],power:[0.0,-10.0,0.0]}
execute if entity @e[tag=firesigil,nbt={Age:239}] at @e[tag=fx_firesigil] run summon small_fireball ~-1 ~2 ~1 {direction:[0.0,-10.0,0.0],power:[0.0,-10.0,0.0]}
execute if entity @e[tag=firesigil,nbt={Age:239}] at @e[tag=fx_firesigil] run summon small_fireball ~1 ~2 ~-1 {direction:[0.0,-10.0,0.0],power:[0.0,-10.0,0.0]}
execute if entity @e[tag=firesigil,nbt={Age:239}] at @e[tag=fx_firesigil] run summon small_fireball ~-1 ~2 ~-1 {direction:[0.0,-10.0,0.0],power:[0.0,-10.0,0.0]}
#
execute if entity @e[tag=firesigil,nbt={Age:239}] at @e[tag=fx_firesigil] run summon small_fireball ~2 ~2 ~2 {direction:[0.0,-10.0,0.0],power:[0.0,-10.0,0.0]}
execute if entity @e[tag=firesigil,nbt={Age:239}] at @e[tag=fx_firesigil] run summon small_fireball ~-2 ~2 ~2 {direction:[0.0,-10.0,0.0],power:[0.0,-10.0,0.0]}
execute if entity @e[tag=firesigil,nbt={Age:239}] at @e[tag=fx_firesigil] run summon small_fireball ~2 ~2 ~-2 {direction:[0.0,-10.0,0.0],power:[0.0,-10.0,0.0]}
execute if entity @e[tag=firesigil,nbt={Age:239}] at @e[tag=fx_firesigil] run summon small_fireball ~-2 ~2 ~-2 {direction:[0.0,-10.0,0.0],power:[0.0,-10.0,0.0]}
execute if entity @e[tag=firesigil,nbt={Age:239}] run kill @e[tag=fx_firesigil]
execute if entity @e[tag=firesigil] run schedule function atrium:magic/magicitems/spells/firesigil_repeat2 1t
