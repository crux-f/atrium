...
execute if entity @a[tag=nourishment_caster,scores={nourish_spell=12..}] run kill @e[tag=nourishment_marker]
execute if entity @a[tag=nourishment_caster,scores={nourish_spell=12..}] run tag @a[tag=nourishment_caster] remove nourishment_caster
execute if entity @a[scores={nourish_spell=12..}] run scoreboard players set @a nourish_spell 0
scoreboard players add @a[tag=nourishment_caster] nourish_spell 1
execute if entity @e[tag=nourishment_caster] run schedule function atrium:magic/magicitems/spells/nourishment_2_repeat 1s
