...
execute at @s run summon area_effect_cloud ~ ~ ~ {Particle:"mycelium",Radius:0.5f,RadiusPerTick:0f,RadiusOnUse:0f,Duration:480,Potion:"minecraft:empty",Effects:[{Id:3,Amplifier:1b,Duration:4800,ShowParticles:1b}]}
# Sound effect
execute at @s run playsound minecraft:entity.bat.takeoff player @a[distance=..30] ~ ~ ~ 0.3 0.9 0.1
