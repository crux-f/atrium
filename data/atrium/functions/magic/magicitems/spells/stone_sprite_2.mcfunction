...
execute at @a[predicate=atrium:stone_sprite_2_req] run summon area_effect_cloud ~ ~ ~ {Particle:"mycelium",Radius:0.5f,RadiusPerTick:0f,RadiusOnUse:0f,Duration:480,Potion:"minecraft:empty",Effects:[{Id:3b,Amplifier:1b,Duration:4800,ShowParticles:1b}]}
# Sound effect
