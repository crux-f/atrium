...
execute as @e[tag=song_spell_ward,scores={charge=250..}] run function atrium:magic/magicitems/spells/song_spell/revert_song_disc_to_normal
...
execute if entity @e[tag=song_spell_ward] run schedule function atrium:magic/magicitems/spells/song_spell/ss_ward 1s