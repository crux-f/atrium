...
execute as @e[tag=song_spell_5,scores={charge=178..}] run function atrium:magic/magicitems/spells/song_spell/revert_song_disc_to_normal
...
execute if entity @e[tag=song_spell_5] run schedule function atrium:magic/magicitems/spells/song_spell/ss_5 1s