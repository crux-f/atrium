...
execute as @e[tag=song_spell_blocks,scores={charge=343..}] run function atrium:magic/magicitems/spells/song_spell/revert_song_disc_to_normal
...
execute if entity @e[tag=song_spell_blocks] run schedule function atrium:magic/magicitems/spells/song_spell/ss_blocks 1s