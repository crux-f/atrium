...
#
# Song: Cat | Duration: 3:06 | [] | Particles: Green
...
execute as @e[tag=song_spell_cat,scores={charge=186..}] run function atrium:magic/magicitems/spells/song_spell/revert_song_disc_to_normal
...
execute if entity @e[tag=song_spell_cat] run schedule function atrium:magic/magicitems/spells/song_spell/ss_cat 1s