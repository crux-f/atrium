...
execute as @e[tag=song_spell_mellohi,scores={charge=98..}] run function atrium:magic/magicitems/spells/song_spell/revert_song_disc_to_normal
...
execute if entity @e[tag=song_spell_mellohi] run schedule function atrium:magic/magicitems/spells/song_spell/ss_mellohi 1s