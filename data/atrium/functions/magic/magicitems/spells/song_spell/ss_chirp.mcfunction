...
execute as @e[tag=song_spell_chirp,scores={charge=187..}] run function atrium:magic/magicitems/spells/song_spell/revert_song_disc_to_normal
...
execute if entity @e[tag=song_spell_chirp] run schedule function atrium:magic/magicitems/spells/song_spell/ss_chirp 1s