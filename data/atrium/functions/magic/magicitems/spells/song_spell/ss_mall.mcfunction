...
execute as @e[tag=song_spell_mall,scores={charge=198..}] run function atrium:magic/magicitems/spells/song_spell/revert_song_disc_to_normal
...
execute if entity @e[tag=song_spell_mall] run schedule function atrium:magic/magicitems/spells/song_spell/ss_mall 1s