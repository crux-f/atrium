...
execute as @a[predicate=atrium:nourishment_2_req] at @s run summon marker ~ ~ ~ {Tags:["nourishment_marker"]}
execute as @a[predicate=atrium:nourishment_2_req] at @s run playsound minecraft:block.bubble_column.upwards_inside player @a[distance=..30] ~ ~ ~ 1 2 0.1
