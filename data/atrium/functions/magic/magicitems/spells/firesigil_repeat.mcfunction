...
execute if entity @e[tag=firesigil,nbt={Age:239}] at @e[tag=fx_firesigil] run summon small_fireball ~ ~2 ~ {power:[0.0,-10.0,0.0]}
execute if entity @e[tag=firesigil,nbt={Age:239}] at @e[tag=fx_firesigil] run summon small_fireball ~1 ~2 ~ {power:[0.0,-10.0,0.0]}
execute if entity @e[tag=firesigil,nbt={Age:239}] at @e[tag=fx_firesigil] run summon small_fireball ~ ~2 ~1 {power:[0.0,-10.0,0.0]}
execute if entity @e[tag=firesigil,nbt={Age:239}] at @e[tag=fx_firesigil] run summon small_fireball ~-1 ~2 ~ {power:[0.0,-10.0,0.0]}
execute if entity @e[tag=firesigil,nbt={Age:239}] at @e[tag=fx_firesigil] run summon small_fireball ~ ~2 ~-1 {power:[0.0,-10.0,0.0]}
