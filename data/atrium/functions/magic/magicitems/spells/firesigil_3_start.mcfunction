...
execute as @a[predicate=atrium:firesigil_3_req] at @s run summon armor_stand ~ ~ ~ {Marker:1b,Invisible:1b,NoBasePlate:1b,PersistenceRequired:1b,Tags:["fx_firesigil_3"]}
execute as @a[predicate=atrium:firesigil_3_req] at @s run summon armor_stand ~ ~ ~ {Marker:1b,Invisible:1b,NoBasePlate:1b,PersistenceRequired:1b,Tags:["fx_firesigil_3_secondary"]}
