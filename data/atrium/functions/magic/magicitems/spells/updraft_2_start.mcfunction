...
execute as @a[predicate=atrium:updraft_2_req] at @s run summon area_effect_cloud ~ ~ ~ {Particle:"cloud",Radius:2f,Duration:480,Tags:["updraft"],Potion:"minecraft:empty",Effects:[{Id:25,Amplifier:3b,Duration:40,ShowParticles:0b}],CustomName:'{"text":"Updraft"}'}
