...
execute at @a[predicate=atrium:stone_sprite_1_req] run summon area_effect_cloud ~ ~ ~ {Particle:"mycelium",Radius:0.3f,RadiusPerTick:0f,RadiusOnUse:0f,Duration:240,Potion:"minecraft:empty",Effects:[{Id:3,Amplifier:0b,Duration:2400,ShowParticles:1b}]}
# Sound effect
