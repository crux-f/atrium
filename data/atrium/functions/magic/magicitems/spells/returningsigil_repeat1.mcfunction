...
execute if entity @e[tag=returningsigil,nbt={Age:239}] at @e[tag=returningsigil_caster] if entity @e[tag=fx_returningsigil,distance=..25] run playsound minecraft:entity.enderman.teleport master @a[distance=..30] ~ ~ ~ 1 1 0.1
