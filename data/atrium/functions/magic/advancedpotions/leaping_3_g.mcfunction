...
#
execute if entity @s[scores={cauldron=3..}] at @s run summon item ~ ~2 ~ {NoGravity:1b,Glowing:1b,Motion:[0.0,0.05,0.0],Item:{id:"minecraft:potion",Count:1b,tag:{leaping3g:1b,display:{Name:'{"text":"Potion of Leaping","color":"#FFDBDB","italic":false}'},CustomPotionEffects:[{Id:8b,Amplifier:2b,Duration:900}],Potion:"minecraft:empty",CustomPotionColor:2293580}}}
