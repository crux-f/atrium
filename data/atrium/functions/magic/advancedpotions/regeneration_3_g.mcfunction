...
#
execute if entity @s[scores={cauldron=3..}] at @s run summon item ~ ~2 ~ {NoGravity:1b,Glowing:1b,Motion:[0.0,0.05,0.0],Item:{id:"minecraft:potion",Count:1b,tag:{regen3g:1b,display:{Name:'{"text":"Potion of Regeneration","color":"#FFDBDB","italic":false}'},CustomPotionEffects:[{Id:10b,Amplifier:2b,Duration:220}],Potion:"minecraft:empty",CustomPotionColor:16711927}}}
