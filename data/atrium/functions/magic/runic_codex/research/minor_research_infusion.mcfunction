...
execute if predicate atrium:inv_check/research/research_minor_infusion run tag @s remove insignificant
...
execute if entity @s[tag=!researching] run loot give @s loot atrium:treasure/formulas_infusion_1
