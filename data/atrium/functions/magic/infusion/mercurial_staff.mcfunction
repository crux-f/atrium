...
#
#
# Check CENTER NORTH for Glowstone
...
execute positioned ~ ~2 ~-2 if entity @e[type=minecraft:item_frame,distance=..1.5,nbt={Item:{id:"minecraft:glowstone",Count:1b}}] run scoreboard players add @s infusion 1
...
# Check SOUTH WEST for Lava Bucket
execute positioned ~-2 ~2 ~2 at @e[type=minecraft:item_frame,distance=..1.5,nbt={Item:{id:"minecraft:lava_bucket",Count:1b}}] run particle minecraft:enchanted_hit ~ ~ ~ 0 0 0 0.1 20 normal
execute positioned ~-2 ~2 ~2 if entity @e[type=minecraft:item_frame,distance=..1.5,nbt={Item:{id:"minecraft:lava_bucket",Count:1b}}] run scoreboard players add @s infusion 1
# Check SOUTH EAST for Water Bucket
execute positioned ~2 ~2 ~4 at @e[type=minecraft:item_frame,distance=..1.5,nbt={Item:{id:"minecraft:water_bucket",Count:1b}}] run particle minecraft:enchanted_hit ~ ~ ~ 0 0 0 0.1 20 normal
execute positioned ~2 ~2 ~4 if entity @e[type=minecraft:item_frame,distance=..1.5,nbt={Item:{id:"minecraft:water_bucket",Count:1b}}] run scoreboard players add @s infusion 1
# Check SOUTH for Amethyst Shard
execute positioned ~ ~2 ~4 at @e[type=minecraft:item_frame,distance=..1.5,nbt={Item:{id:"minecraft:amethyst_shard",Count:1b}}] run particle minecraft:enchanted_hit ~ ~ ~ 0 0 0 0.1 20 normal
execute positioned ~ ~2 ~4 if entity @e[type=minecraft:item_frame,distance=..1.5,nbt={Item:{id:"minecraft:amethyst_shard",Count:1b}}] run scoreboard players add @s infusion 1
#
execute if entity @s[scores={infusion=5..}] at @s run summon item ~ ~3 ~ {NoGravity:1b,Glowing:1b,Item:{id:"minecraft:trident",Count:1b,tag:{display:{Name:'[{"text":"M","color":"#002db3","italic":false},{"text":"e","color":"#212BAC"},{"text":"r","color":"#2F29AF"},{"text":"c","color":"#3A289D"},{"text":"u","color":"#432895"},{"text":"r","color":"#4A248C"},{"text":"i","color":"#522183"},{"text":"a","color":"#581F7A"},{"text":"l","color":"#5E1C6F"},{"text":" S","color":"#641a63"},{"text":"t","color":"#691656"},{"text":"a","color":"#6E1347"},{"text":"f","color":"#730e32"},{"text":"f","color":"#780707"}]',Lore:['{"text":"Mending","color":"gray","italic":false}','{"text":"Component: Transmutation Powder","color":"gray","italic":false}','{"text":"Fizzle Spell","color":"#FFBFBF","italic":false}','{"text":"Destabilize Item","color":"#FFF6A1","italic":false}','{"text":"Catalyze","color":"dark_gray","italic":false}','{"text":" "}','{"text":"When in Off Hand:","color":"gray","italic":false}','{"text":"+3 Casting Power","color":"blue","italic":false}']},HideFlags:1,RepairCost:99,staff:1b,lv2:1b,mercurialstaff:1b,weird_combo:1b,Enchantments:[{id:"minecraft:riptide",lvl:2s},{id:"minecraft:mending",lvl:1s}],AttributeModifiers:[{AttributeName:"generic.attack_damage",Name:"generic.attack_damage",Amount:2,Operation:0,UUID:[I;-67466694,96486364,-1852725672,-1413614998],Slot:"mainhand"}]}}}
