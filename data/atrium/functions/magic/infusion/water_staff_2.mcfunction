...
#
#
# Check CENTER NORTH for Scute
execute positioned ~ ~2 ~-2 at @e[type=minecraft:item_frame,distance=..1.5,nbt={Item:{id:"minecraft:scute",Count:1b}}] run particle minecraft:enchanted_hit ~ ~ ~ 0 0 0 0.1 20 normal
execute positioned ~ ~2 ~-2 if entity @e[type=minecraft:item_frame,distance=..1.5,nbt={Item:{id:"minecraft:scute",Count:1b}}] run scoreboard players add @s infusion 1
...
#
execute if entity @s[scores={infusion=5..}] at @s run summon item ~ ~3 ~ {NoGravity:1b,Glowing:1b,Item:{id:"minecraft:trident",Count:1b,tag:{display:{Name:'{"text":"Staff of Water","color":"dark_blue","italic":false}',Lore:['{"text":"Mending","color":"gray","italic":false}','{"text":"Nourishment II","color":"#FFBFBF","italic":false}','{"text":"Extinguish II","color":"#FFF29E","italic":false}','{"keybind":"","italic":false}','{"text":"When in Off Hand:","color":"gray","italic":false}','{"text":"+2 Casting Power","color":"blue","italic":false}']},HideFlags:1,RepairCost:99,waterstaff:1b,lv2:1b,Enchantments:[{id:"minecraft:power",lvl:2s}],AttributeModifiers:[{AttributeName:"generic.attack_damage",Name:"generic.attack_damage",Amount:2,Operation:0,UUID:[I;391947285,319243430,-1723587974,-418005052],Slot:"mainhand"}]}}}
