...
#
#
# Check CENTER NORTH for Brightsteel Ingot
execute positioned ~ ~2 ~-2 at @e[type=minecraft:item_frame,distance=..1.5,nbt={Item:{tag:{brightsteel_ingot:1b}}}] run particle minecraft:enchanted_hit ~ ~ ~ 0 0 0 0.1 20 normal
execute positioned ~ ~2 ~-2 if entity @e[type=minecraft:item_frame,distance=..1.5,nbt={Item:{tag:{brightsteel_ingot:1b}}}] run scoreboard players add @s infusion 1
...
# Check CENTER SOUTH for Air Staff II
...
# Check SOUTH for Bottle o' Dreams
execute positioned ~ ~2 ~4 at @e[type=minecraft:item_frame,distance=..1.5,nbt={Item:{tag:{bottle_o_dreams:1b}}}] run particle minecraft:enchanted_hit ~ ~ ~ 0 0 0 0.1 20 normal
execute positioned ~ ~2 ~4 if entity @e[type=minecraft:item_frame,distance=..1.5,nbt={Item:{tag:{bottle_o_dreams:1b}}}] run scoreboard players add @s infusion 1
#
execute if entity @s[scores={infusion=5..}] at @s run summon item ~ ~3 ~ {NoGravity:1b,Glowing:1b,Item:{id:"minecraft:trident",Count:1b,tag:{display:{Name:'{"text":"Staff of Air","color":"#BFBF1B","italic":false,"underlined":true}',Lore:['{"text":"Mending","color":"gray","italic":false}','{"text":"Component: Shimmering Feather","color":"gray","italic":false}','{"text":"Updraft III","color":"#FFBFBF","italic":false}','{"text":"Increase Velocity III","color":"#FFF29E","italic":false}','{"text":"Dance","color":"gold","italic":false}','{"text":" "}','{"text":"When in Off-Hand:","color":"gray","italic":false}','{"text":"+3 Casting Power","color":"blue","italic":false}']},HideFlags:1,RepairCost:99,airstaff:1b,staff:1b,lv3:1b,Enchantments:[{id:"minecraft:riptide",lvl:1s},{id:"minecraft:mending",lvl:1s}],AttributeModifiers:[{AttributeName:"generic.attack_damage",Name:"generic.attack_damage",Amount:2,Operation:0,UUID:[I;30719264,-583186377,-1902179646,1722003442],Slot:"mainhand"}]}}}
