...
#
execute if entity @s[scores={infusion=5..}] at @s run summon item ~ ~3 ~ {NoGravity:1b,Glowing:1b,Item:{id:"minecraft:trident",Count:1b,tag:{display:{Name:'{"text":"Staff of Air","color":"#BFBF1B","italic":false,"underlined":true}',Lore:['{"text":"Component: Shimmering Feather","color":"gray","italic":false}','{"text":"Updraft III","color":"#FFBFBF","italic":false}','{"text":"Increase Velocity III","color":"#FFF29E","italic":false}','{"text":"Dance","color":"gold","italic":false}','{"text":" "}','{"text":"When in Off-Hand:","color":"gray","italic":false}','{"text":"+3 Casting Power","color":"blue","italic":false}']},HideFlags:1,airstaff:1b,staff:1b,lv3:1b,Enchantments:[{id:"minecraft:riptide",lvl:1s},{id:"minecraft:mending",lvl:1s}],AttributeModifiers:[{AttributeName:"generic.attack_damage",Name:"generic.attack_damage",Amount:2,Operation:0,UUID:[I;30719264,-583186377,-1902179646,1722003442],Slot:"mainhand"}]}}}
