...
#
execute if entity @s[scores={infusion=5..}] at @s run summon item ~ ~3 ~ {NoGravity:1b,Glowing:1b,Item:{id:"minecraft:trident",Count:1b,tag:{display:{Name:'{"text":"Staff of Earth","color":"#5CFF8D","italic":false,"underlined":true}',Lore:['{"text":"Component: Garden Shard","color":"gray","italic":false}','{"text":"Natural Armor III","color":"#FFBFBF","italic":false}','{"text":"Stone Spirit III","color":"#FFF6A1","italic":false}','{"text":"Return","color":"green","italic":false}','{"text":" "}','{"text":"When in Off Hand:","color":"gray","italic":false}','{"text":"+3 Casting Power","color":"blue","italic":false}']},HideFlags:1,staff:1b,lv3:1b,earthstaff:1b,Enchantments:[{id:"minecraft:riptide",lvl:1s},{id:"minecraft:mending",lvl:1s}],AttributeModifiers:[{AttributeName:"generic.attack_damage",Name:"generic.attack_damage",Amount:2,Operation:0,UUID:[I;-67466694,96486364,-1852725672,-1413614998],Slot:"mainhand"}]}}}
