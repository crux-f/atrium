...
#
execute if entity @s[scores={infusion=5..}] at @s run summon item ~ ~3 ~ {NoGravity:1b,Glowing:1b,Item:{id:"minecraft:trident",Count:1b,tag:{display:{Name:'{"text":"Staff of Air","color":"yellow","italic":false}',Lore:['{"text":"Mending","color":"gray","italic":false}','{"text":"Updraft I","color":"#FFBFBF","italic":false}','{"text":"Increase Velocity I","color":"#FFF29E","italic":false}','{"keybind":"","color":"gray","italic":false}','{"text":"When in Off Hand:","color":"gray","italic":false}','{"text":"+1 Casting Power","color":"blue","italic":false}']},HideFlags:1,RepairCost:99,airstaff:1b,staff:1b,lv1:1b,Enchantments:[{id:"minecraft:riptide",lvl:3s},{id:"minecraft:mending",lvl:1s}],AttributeModifiers:[{AttributeName:"generic.attack_damage",Name:"generic.attack_damage",Amount:2,Operation:0,UUID:[I;-398377370,-1777316415,-1450025143,-577324410],Slot:"mainhand"}]}}}
