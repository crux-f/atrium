...
#
#
# Check CENTER NORTH for Tipped Arrow of Swiftness (1:00)
execute positioned ~ ~2 ~-2 at @e[type=minecraft:item_frame,distance=..1.5,nbt={Item:{id:"minecraft:tipped_arrow",Count:1b,tag:{Potion:"minecraft:long_swiftness"}}}] run particle minecraft:enchanted_hit ~ ~ ~ 0 0 0 0.1 20 normal
execute positioned ~ ~2 ~-2 if entity @e[type=minecraft:item_frame,distance=..1.5,nbt={Item:{id:"minecraft:tipped_arrow",Count:1b,tag:{Potion:"minecraft:long_swiftness"}}}] run scoreboard players add @s infusion 1
...
execute positioned ~ ~2 ~4 at @e[type=minecraft:item_frame,distance=..1.5,nbt={Item:{id:"minecraft:white_stained_glass",Count:1b}}] run particle minecraft:enchanted_hit ~ ~ ~ 0 0 0 0.1 20 normal
execute positioned ~ ~2 ~4 if entity @e[type=minecraft:item_frame,distance=..1.5,nbt={Item:{id:"minecraft:white_stained_glass",Count:1b}}] run scoreboard players add @s infusion 1
#
