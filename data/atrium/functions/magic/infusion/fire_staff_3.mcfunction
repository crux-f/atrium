...
#
#
# Check CENTER NORTH for Netherite Ingot
execute positioned ~ ~2 ~-2 at @e[type=minecraft:item_frame,distance=..1.5,nbt={Item:{id:"minecraft:netherite_ingot",Count:1b}}] run particle minecraft:enchanted_hit ~ ~ ~ 0 0 0 0.1 20 normal
execute positioned ~ ~2 ~-2 if entity @e[type=minecraft:item_frame,distance=..1.5,nbt={Item:{id:"minecraft:netherite_ingot",Count:1b}}] run scoreboard players add @s infusion 1
...
# Check CENTER EAST for Draft of the Prism
...
# Check CENTER SOUTH for Fire Staff II
...
# Check SOUTH for Hellish Lantern (fully charged)
execute positioned ~ ~2 ~4 at @e[type=minecraft:item_frame,distance=..1.5,nbt={Item:{tag:{hellish_lantern:1b,charges:10b}}}] run particle minecraft:enchanted_hit ~ ~ ~ 0 0 0 0.1 20 normal
execute positioned ~ ~2 ~4 if entity @e[type=minecraft:item_frame,distance=..1.5,nbt={Item:{tag:{hellish_lantern:1b,charges:10b}}}] run scoreboard players add @s infusion 1
#
execute if entity @s[scores={infusion=5..}] at @s run summon item ~ ~3 ~ {NoGravity:1b,Glowing:1b,Item:{id:"minecraft:trident",Count:1b,tag:{display:{Name:'{"text":"Staff of Fire","color":"#E34400","italic":false,"underlined":true}',Lore:['{"text":"Mending","color":"gray","italic":false}','{"text":"Component: Primordial Stone","color":"gray","italic":false}','{"text":"Fire Sigil III","color":"#FFBFBF","italic":false}','{"text":"Throw Flames III","color":"#FFF6A1","italic":false}','{"text":"Meteor","color":"dark_red","italic":false}','{"text":" "}','{"text":"When in Off Hand:","color":"gray","italic":false}','{"text":"+3 Casting Power","color":"blue","italic":false}']},HideFlags:1,RepairCost:99,staff:1b,lv3:1b,firestaff:1b,Enchantments:[{id:"minecraft:fire_aspect",lvl:3s},{id:"minecraft:riptide",lvl:1s},{id:"minecraft:mending",lvl:1s}],AttributeModifiers:[{AttributeName:"generic.attack_damage",Name:"generic.attack_damage",Amount:2,Operation:0,UUID:[I;-67466694,96486364,-1852725672,-1413614998],Slot:"mainhand"}]}}}
