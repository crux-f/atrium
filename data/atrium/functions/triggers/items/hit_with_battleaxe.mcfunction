...
execute if predicate atrium:player/inventory/holding_nothing_offhand at @s anchored eyes positioned ^ ^ ^1.5 as @e[limit=1,nbt=!{HurtTime:0s},distance=..4] run damage @s 3 atrium:extra_weapon_damage
