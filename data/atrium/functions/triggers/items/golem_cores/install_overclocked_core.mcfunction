...
advancement revoke @s only atrium:triggers/items/golem_cores/install_overclocked_core
#
...
execute at @s positioned ^ ^ ^1.5 as @e[limit=1,tag=atrium_installing_core,sort=nearest,distance=..5] run effect give @s minecraft:speed infinite
...
execute at @s positioned ^ ^ ^1.5 as @e[limit=1,tag=atrium_installing_core,sort=nearest,distance=..5] run tag @s add atrium_overclocked_core_installed
