...
advancement revoke @s only atrium:triggers/items/quest_maps/mineshaft_quest_complete
# Tag player
...
schedule function atrium:triggers/items/quest_maps/take_map/mineshaft_quest 1t
