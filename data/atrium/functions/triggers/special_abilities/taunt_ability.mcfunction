...
advancement revoke @a[tag=!taunted] only atrium:triggers/special_abilities/taunt_ability
execute if entity @a[tag=taunted] run schedule function atrium:triggers/special_abilities/taunt_ability 1t
