...
execute if entity @s[predicate=atrium:entity/is_in_palace] if entity @e[tag=atrium_eye_of_the_nameless,distance=..100] run effect give @s minecraft:mining_fatigue 2 2 false