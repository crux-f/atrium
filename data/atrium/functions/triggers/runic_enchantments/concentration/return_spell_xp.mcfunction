...
execute if entity @s[nbt={Inventory:[{Slot:-106b,tag:{atrium_concentration_lv:4b,atrium_staff_lv:1b}}]}] at @s run summon minecraft:experience_orb ~ ~ ~ {Value:24}
execute if entity @s[nbt={Inventory:[{Slot:-106b,tag:{atrium_concentration_lv:4b,atrium_staff_lv:2b}}]}] at @s run summon minecraft:experience_orb ~ ~ ~ {Value:48}
execute if entity @s[nbt={Inventory:[{Slot:-106b,tag:{atrium_concentration_lv:4b,atrium_staff_lv:3b}}]}] at @s run summon minecraft:experience_orb ~ ~ ~ {Value:72}
