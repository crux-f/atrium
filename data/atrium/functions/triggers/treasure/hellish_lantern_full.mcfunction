...
clear @s minecraft:carved_pumpkin{hellish_lantern:1b,charges:9b} 1
give @s jack_o_lantern{display:{Name:'{"text":"Hellish Lantern","color":"red","italic":false}',Lore:['{"text":"The hellfire roars within it!"}','{"text":"The lantern seems satisfied."}','{"text":" "}','[{"text":"Absorbed Ghast Fireballs:","color":"gray","italic":false},{"text":" 10","color":"yellow"}]']},hellish_lantern:1b,charges:10b,Enchantments:[{id:"minecraft:power",lvl:3s}]} 1
#
# SFX
