...
execute as @a[tag=atrium_song_caster] at @s[nbt={SelectedItem:{id:"minecraft:music_disc_5"}}] run summon item ~ ~ ~ {NoGravity:1b,Glowing:1b,Age:-10000,Health:25,PickupDelay:3560,Motion:[0.0,0.1,0.0],Tags:["atrium_floating_disc","song_spell_5"],Item:{id:"minecraft:disc_fragment_5",Count:9b}}
execute as @a[tag=atrium_song_caster] at @s[nbt={SelectedItem:{id:"minecraft:music_disc_11"}}] run summon item ~ ~ ~ {NoGravity:1b,Glowing:1b,Age:-10000,Health:25,PickupDelay:1420,Motion:[0.0,0.1,0.0],Tags:["atrium_floating_disc","song_spell_11"],Item:{id:"minecraft:music_disc_11",Count:1b}}
execute as @a[tag=atrium_song_caster] at @s[nbt={SelectedItem:{id:"minecraft:music_disc_13"}}] run summon item ~ ~ ~ {NoGravity:1b,Glowing:1b,Age:-10000,Health:25,PickupDelay:3540,Motion:[0.0,0.1,0.0],Tags:["atrium_floating_disc","song_spell_13"],Item:{id:"minecraft:music_disc_13",Count:1b}}
execute as @a[tag=atrium_song_caster] at @s[nbt={SelectedItem:{id:"minecraft:music_disc_blocks"}}] run summon item ~ ~ ~ {NoGravity:1b,Glowing:1b,Age:-10000,Health:25,PickupDelay:6860,Motion:[0.0,0.1,0.0],Tags:["atrium_floating_disc","song_spell_blocks"],Item:{id:"minecraft:music_disc_blocks",Count:1b}}
execute as @a[tag=atrium_song_caster] at @s[nbt={SelectedItem:{id:"minecraft:music_disc_cat"}}] run summon item ~ ~ ~ {NoGravity:1b,Glowing:1b,Age:-10000,Health:25,PickupDelay:3720,Motion:[0.0,0.1,0.0],Tags:["atrium_floating_disc","song_spell_cat"],Item:{id:"minecraft:music_disc_cat",Count:1b}}
execute as @a[tag=atrium_song_caster] at @s[nbt={SelectedItem:{id:"minecraft:music_disc_chirp"}}] run summon item ~ ~ ~ {NoGravity:1b,Glowing:1b,Age:-10000,Health:25,PickupDelay:3740,Motion:[0.0,0.1,0.0],Tags:["atrium_floating_disc","song_spell_chirp"],Item:{id:"minecraft:music_disc_chirp",Count:1b}}
execute as @a[tag=atrium_song_caster] at @s[nbt={SelectedItem:{id:"minecraft:music_disc_far"}}] run summon item ~ ~ ~ {NoGravity:1b,Glowing:1b,Age:-10000,Health:25,PickupDelay:3840,Motion:[0.0,0.1,0.0],Tags:["atrium_floating_disc","song_spell_far"],Item:{id:"minecraft:music_disc_far",Count:1b}}
execute as @a[tag=atrium_song_caster] at @s[nbt={SelectedItem:{id:"minecraft:music_disc_mall"}}] run summon item ~ ~ ~ {NoGravity:1b,Glowing:1b,Age:-10000,Health:25,PickupDelay:3960,Motion:[0.0,0.1,0.0],Tags:["atrium_floating_disc","song_spell_mall"],Item:{id:"minecraft:music_disc_mall",Count:1b}}
execute as @a[tag=atrium_song_caster] at @s[nbt={SelectedItem:{id:"minecraft:music_disc_mellohi"}}] run summon item ~ ~ ~ {NoGravity:1b,Glowing:1b,Age:-10000,Health:25,PickupDelay:1960,Motion:[0.0,0.1,0.0],Tags:["atrium_floating_disc","song_spell_mellohi"],Item:{id:"minecraft:music_disc_mellohi",Count:1b}}
execute as @a[tag=atrium_song_caster] at @s[nbt={SelectedItem:{id:"minecraft:music_disc_otherside"}}] run summon item ~ ~ ~ {NoGravity:1b,Glowing:1b,Age:-10000,Health:25,PickupDelay:3900,Motion:[0.0,0.1,0.0],Tags:["atrium_floating_disc","song_spell_otherside"],Item:{id:"minecraft:music_disc_otherside",Count:1b}}
execute as @a[tag=atrium_song_caster] at @s[nbt={SelectedItem:{id:"minecraft:music_disc_pigstep"}}] run summon item ~ ~ ~ {NoGravity:1b,Glowing:1b,Age:-10000,Health:25,PickupDelay:2960,Motion:[0.0,0.1,0.0],Tags:["atrium_floating_disc","song_spell_pigstep"],Item:{id:"minecraft:music_disc_pigstep",Count:1b}}
execute as @a[tag=atrium_song_caster] at @s[nbt={SelectedItem:{id:"minecraft:music_disc_stal"}}] run summon item ~ ~ ~ {NoGravity:1b,Glowing:1b,Age:-10000,Health:25,PickupDelay:3040,Motion:[0.0,0.1,0.0],Tags:["atrium_floating_disc","song_spell_stal"],Item:{id:"minecraft:music_disc_stal",Count:1b}}
execute as @a[tag=atrium_song_caster] at @s[nbt={SelectedItem:{id:"minecraft:music_disc_strad"}}] run summon item ~ ~ ~ {NoGravity:1b,Glowing:1b,Age:-10000,Health:25,PickupDelay:3780,Motion:[0.0,0.1,0.0],Tags:["atrium_floating_disc","song_spell_strad"],Item:{id:"minecraft:music_disc_strad",Count:1b}}
execute as @a[tag=atrium_song_caster] at @s[nbt={SelectedItem:{id:"minecraft:music_disc_wait"}}] run summon item ~ ~ ~ {NoGravity:1b,Glowing:1b,Age:-10000,Health:25,PickupDelay:4680,Motion:[0.0,0.1,0.0],Tags:["atrium_floating_disc","song_spell_wait"],Item:{id:"minecraft:music_disc_wait",Count:1b}}
execute as @a[tag=atrium_song_caster] at @s[nbt={SelectedItem:{id:"minecraft:music_disc_ward"}}] run summon item ~ ~ ~ {NoGravity:1b,Glowing:1b,Age:-10000,Health:25,PickupDelay:5000,Motion:[0.0,0.1,0.0],Tags:["atrium_floating_disc","song_spell_ward"],Item:{id:"minecraft:music_disc_ward",Count:1b}}
execute as @a[tag=atrium_song_caster] at @s[nbt={SelectedItem:{id:"minecraft:music_disc_relic"}}] run summon item ~ ~ ~ {NoGravity:1b,Glowing:1b,Age:-10000,Health:25,PickupDelay:4360,Motion:[0.0,0.1,0.0],Tags:["atrium_floating_disc","song_spell_relic"],Item:{id:"minecraft:music_disc_relic",Count:1b}}
#
