...
execute if data entity @s {Inventory:[{Slot:-106b,tag:{atrium_staff_lv:1b}}]} run summon area_effect_cloud ~ ~ ~ {Particle:"minecraft:splash",Radius:1.5f,Duration:1200,Tags:["atrium_water_sigil"],Potion:"minecraft:empty",RadiusPerTick:-0.001f,CustomName:'{"text":"Water Sigil I"}'}
execute if data entity @s {Inventory:[{Slot:-106b,tag:{atrium_staff_lv:2b}}]} run summon area_effect_cloud ~ ~ ~ {Particle:"minecraft:splash",Radius:1.5f,Duration:2400,Tags:["atrium_water_sigil"],Potion:"minecraft:empty",RadiusPerTick:-0.0001f,CustomName:'{"text":"Water Sigil II"}'}
execute if data entity @s {Inventory:[{Slot:-106b,tag:{atrium_staff_lv:3b}}]} run summon area_effect_cloud ~ ~ ~ {Particle:"minecraft:splash",Radius:1.5f,Duration:4800,Tags:["atrium_water_sigil"],Potion:"minecraft:empty",RadiusPerTick:-0.00001f,CustomName:'{"text":"Water Sigil III"}'}
#
# Summon raincloud (cosmetic)
execute if data entity @s {Inventory:[{Slot:-106b,tag:{atrium_staff_lv:1b}}]} run summon area_effect_cloud ~ ~10 ~ {Particle:"minecraft:rain",Radius:3f,Duration:1180}
