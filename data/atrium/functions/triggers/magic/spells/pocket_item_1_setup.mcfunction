...
#
# Run the next script 3 seconds later UNLESS the player's Ender Chest is completely full.
execute unless data entity @s EnderItems[26] run schedule function atrium:triggers/magic/spells/pocket_item_put 3s
#
