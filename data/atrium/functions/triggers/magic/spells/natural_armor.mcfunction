...
execute unless entity @s[predicate=atrium:player/inventory/wearing_any_armor] if data entity @s {Inventory:[{Slot:-106b,tag:{atrium_staff_lv:1b}}]} run effect give @s resistance 900 2 true
execute unless entity @s[predicate=atrium:player/inventory/wearing_any_armor] if data entity @s {Inventory:[{Slot:-106b,tag:{atrium_staff_lv:2b}}]} run effect give @s resistance 1800 2 true
execute unless entity @s[predicate=atrium:player/inventory/wearing_any_armor] if data entity @s {Inventory:[{Slot:-106b,tag:{atrium_staff_lv:3b}}]} run effect give @s resistance 3600 2 true
#
# Spell cleanup
