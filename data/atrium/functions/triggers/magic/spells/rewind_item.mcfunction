...
execute if entity @s[nbt={Inventory:[{Slot:-106b,tag:{atrium_staff_lv:2b}}]}] run schedule function atrium:triggers/magic/spells/rewind_item_1 3s
execute if entity @s[nbt={Inventory:[{Slot:-106b,tag:{atrium_staff_lv:3b}}]}] run schedule function atrium:triggers/magic/spells/rewind_item_2 3s
# Spell cleanup
