...
execute as @e[tag=song_spell_far,scores={charge=174..}] run function atrium:triggers/magic/spells/song/revert_song_disc_to_normal
...
execute if entity @e[tag=song_spell_far] run schedule function atrium:triggers/magic/spells/song/ss_far 1s