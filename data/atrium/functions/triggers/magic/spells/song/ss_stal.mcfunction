...
execute as @e[tag=song_spell_stal,scores={charge=152..}] run function atrium:triggers/magic/spells/song/revert_song_disc_to_normal
...
execute if entity @e[tag=song_spell_stal] run schedule function atrium:triggers/magic/spells/song/ss_stal 1s