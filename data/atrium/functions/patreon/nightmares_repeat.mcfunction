...
#
schedule function atrium:patreon/nightmares_repeat 10s
...
execute at @a[scores={nightmare_anomaly=312000..}] at @e[type=minecraft:phantom,nbt={Size:10},distance=..50,tag=!minion] if predicate atrium:percentage_chances/0.05_p run function atrium:patreon/summon_little_nightmare
