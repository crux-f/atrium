...
execute positioned ~ ~ ~2 if entity @e[type=minecraft:glow_item_frame,distance=..1.5,nbt={Item:{id:"minecraft:diamond",Count:1b}}] run function atrium:formula_crafting/infusion/i_recipes/inert_focus
...
execute positioned ~ ~ ~-4 if entity @e[type=minecraft:glow_item_frame,distance=..1.5,nbt={Item:{id:"minecraft:glowstone_dust",Count:1b}}] run function atrium:formula_crafting/infusion/i_recipes/air_staff_1
...
execute positioned ~ ~ ~-4 if entity @e[type=minecraft:glow_item_frame,distance=..1.5,nbt={Item:{id:"minecraft:emerald",Count:1b}}] run function atrium:formula_crafting/infusion/i_recipes/earth_staff_1
...
execute positioned ~ ~ ~-4 if entity @e[type=minecraft:glow_item_frame,distance=..1.5,nbt={Item:{id:"minecraft:redstone",Count:1b}}] run function atrium:formula_crafting/infusion/i_recipes/fire_staff_1
...
execute positioned ~ ~ ~-4 if entity @e[type=minecraft:glow_item_frame,distance=..1.5,nbt={Item:{id:"minecraft:lapis_lazuli",Count:1b}}] run function atrium:formula_crafting/infusion/i_recipes/water_staff_1
...
execute positioned ~ ~ ~-4 if entity @e[type=minecraft:glow_item_frame,distance=..1.5,nbt={Item:{id:"minecraft:quartz",Count:1b}}] run function atrium:formula_crafting/infusion/i_recipes/time_staff_1
...
execute positioned ~ ~ ~-4 if entity @e[type=minecraft:glow_item_frame,distance=..1.5,nbt={Item:{id:"minecraft:coal",Count:1b}}] run function atrium:formula_crafting/infusion/i_recipes/space_staff_1
