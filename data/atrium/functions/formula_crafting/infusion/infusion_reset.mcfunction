...
#
# Remove old frames
kill @e[distance=..10,tag=atrium_crafting_slot,type=minecraft:glow_item_frame]
# CENTER NORTH
execute positioned ~ ~ ~-2 run summon minecraft:glow_item_frame ~ ~ ~ {Facing:1b,Invisible:1b,Tags:["atrium_crafting_slot"],Item:{}}
...
#
# NORTH
execute positioned ~ ~ ~-4 run summon minecraft:glow_item_frame ~ ~ ~ {Facing:1b,Invisible:1b,Tags:["atrium_crafting_slot"],Item:{}}
execute positioned ~ ~ ~-4 run particle minecraft:portal ~ ~ ~ 0.1 0.5 0.1 0.1 15
# NORTH-EAST
execute positioned ~3 ~ ~-3 run summon minecraft:glow_item_frame ~ ~ ~ {Facing:1b,Invisible:1b,Tags:["atrium_crafting_slot"],Item:{}}
