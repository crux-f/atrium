...
execute at @s positioned ~-5 ~2 ~ as @e[type=minecraft:item_frame,distance=..1.5,nbt={Item:{tag:{LodestoneTracked:1b,Enchantments:[{id:"minecraft:lure"}]}}}] run scoreboard players set @s atrium_xp_multiplier -99
execute at @s positioned ~-5 ~2 ~ as @e[type=minecraft:item_frame,distance=..1.5,nbt={Item:{tag:{LodestoneTracked:1b}}},nbt=!{Item:{tag:{Enchantments:[{id:"minecraft:lure"}]}}}] run scoreboard players set @s atrium_xp_multiplier -95
#
...
execute at @s positioned ~-5 ~2 ~ as @e[type=minecraft:item_frame,distance=..1.5,nbt={Item:{tag:{LodestoneTracked:1b}}}] store result score @s atrium_z_coordinate run data get entity @s Item.tag.LodestonePos.Z 1
#
...
execute at @s positioned ~-5 ~2 ~ run scoreboard players operation @e[limit=1,type=minecraft:item_frame,distance=..1.5,nbt={Item:{tag:{LodestoneTracked:1b}}}] atrium_x_coordinate -= @s atrium_x_coordinate
execute at @s positioned ~-5 ~2 ~ run scoreboard players operation @e[limit=1,type=minecraft:item_frame,distance=..1.5,nbt={Item:{tag:{LodestoneTracked:1b}}}] atrium_y_coordinate -= @s atrium_y_coordinate
execute at @s positioned ~-5 ~2 ~ run scoreboard players operation @e[limit=1,type=minecraft:item_frame,distance=..1.5,nbt={Item:{tag:{LodestoneTracked:1b}}}] atrium_z_coordinate -= @s atrium_z_coordinate
# Multiply the distance values by the xp multiplier 
execute at @s positioned ~-5 ~2 ~ as @e[limit=1,type=minecraft:item_frame,distance=..1.5,nbt={Item:{tag:{LodestoneTracked:1b}}}] run scoreboard players operation @s atrium_x_coordinate *= @s atrium_xp_multiplier
execute at @s positioned ~-5 ~2 ~ as @e[limit=1,type=minecraft:item_frame,distance=..1.5,nbt={Item:{tag:{LodestoneTracked:1b}}}] run scoreboard players operation @s atrium_y_coordinate *= @s atrium_xp_multiplier
execute at @s positioned ~-5 ~2 ~ as @e[limit=1,type=minecraft:item_frame,distance=..1.5,nbt={Item:{tag:{LodestoneTracked:1b}}}] run scoreboard players operation @s atrium_z_coordinate *= @s atrium_xp_multiplier
# And divide all of them by 100
execute at @s positioned ~-5 ~2 ~ as @e[limit=1,type=minecraft:item_frame,distance=..1.5,nbt={Item:{tag:{LodestoneTracked:1b}}}] run scoreboard players operation @s atrium_x_coordinate /= @s charge
