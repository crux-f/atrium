...
execute positioned ~-2 ~ ~ if entity @e[type=minecraft:glow_item_frame,distance=..1.5,nbt={Item:{id:"minecraft:birch_wood",Count:1b}}] run scoreboard players add @s valid_ingredients 1
...
#
execute if entity @s[scores={valid_ingredients=4..}] at @s run summon item ~ ~1 ~ {Motion:[0.0,0.02,0.0],NoGravity:1b,Glowing:1b,Item:{id:"minecraft:potion",Count:1b,tag:{display:{Name:'{"text":"Birch Beer","italic":false}'},CustomModelData:333192,atrium_birch_beer:1b,custom_potion_effects:[{id:"minecraft:regeneration",amplifier:1b,duration:120,show_particles:1b,show_icon:1b,ambient:1b},{id:"minecraft:weakness",amplifier:0b,duration:1200,show_particles:1b,show_icon:1b,ambient:1b},{id:"minecraft:saturation",amplifier:1b,duration:100,show_particles:0b,show_icon:0b}],CustomPotionColor:11870217}}}
