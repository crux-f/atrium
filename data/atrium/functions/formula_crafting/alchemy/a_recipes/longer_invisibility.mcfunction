...
#
execute if entity @s[scores={valid_ingredients=3..}] at @s run summon item ~ ~1 ~ {Motion:[0.0,0.02,0.0],NoGravity:1b,Glowing:1b,Item:{id:"minecraft:potion",Count:1b,tag:{display:{Name:'{"text":"Potion of Invisibility","italic":false}'},CustomModelData:333067,atrium_longer_invisibility:1b,atrium_tier_3_potion:1b,CustomPotionEffects:[{Id:14,Amplifier:0b,Duration:20400,ShowParticles:1b}],Potion:"minecraft:empty",CustomPotionColor:8356754}}}
