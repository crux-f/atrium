...
#
execute if entity @s[scores={valid_ingredients=3..}] at @s run summon item ~ ~1 ~ {Motion:[0.0,0.02,0.0],NoGravity:1b,Glowing:1b,Item:{id:"minecraft:potion",Count:1b,tag:{display:{Name:'{"text":"Potion of Water Breathing","italic":false}'},CustomModelData:333067,atrium_longer_water_breathing:1b,atrium_tier_3_potion:1b,custom_potion_effects:[{id:"minecraft:water_breathing",amplifier:0b,duration:20400,show_particles:1b}],Potion:"minecraft:empty",CustomPotionColor:9885630}}}
