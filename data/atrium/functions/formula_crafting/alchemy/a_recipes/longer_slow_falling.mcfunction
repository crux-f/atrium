...
#
execute if entity @s[scores={valid_ingredients=3..}] at @s run summon item ~ ~1 ~ {Motion:[0.0,0.02,0.0],NoGravity:1b,Glowing:1b,Item:{id:"minecraft:potion",Count:1b,tag:{display:{Name:'{"text":"Potion of Slow Falling","italic":false}'},CustomModelData:333067,atrium_longer_slow_falling:1b,atrium_tier_3_potion:1b,CustomPotionEffects:[{Id:28,Amplifier:0b,Duration:9600,ShowParticles:1b}],Potion:"minecraft:empty",CustomPotionColor:16773073}}}
