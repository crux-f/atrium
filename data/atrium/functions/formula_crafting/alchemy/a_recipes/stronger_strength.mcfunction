...
#
execute if entity @s[scores={valid_ingredients=3..}] at @s run summon item ~ ~1 ~ {Motion:[0.0,0.02,0.0],NoGravity:1b,Glowing:1b,Item:{id:"minecraft:potion",Count:1b,tag:{display:{Name:'{"text":"Potion of Strength","italic":false}'},CustomModelData:333067,atrium_stronger_strength:1b,atrium_tier_3_potion:1b,CustomPotionEffects:[{Id:5,Amplifier:2b,Duration:900,ShowParticles:1b}],Potion:"minecraft:empty",CustomPotionColor:9643043}}}
