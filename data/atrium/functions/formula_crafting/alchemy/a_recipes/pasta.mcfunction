...
#
execute if entity @s[scores={valid_ingredients=4..}] at @s run summon item ~ ~1 ~ {Motion:[0.0,0.02,0.0],NoGravity:1b,Glowing:1b,Item:{id:"minecraft:beetroot_soup",Count:1b,tag:{display:{Name:'{"text":"Pasta","italic":false}'},CustomModelData:333170,atrium_pasta:1b}}}
