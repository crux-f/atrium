...
execute positioned ~ ~ ~-7 run tellraw @p[gamemode=!spectator] {"text":"(The altar is damaged. It requires all three of its hoppers, at least 4 candles, and a gray carpet to function.)","italic":true,"color":"red"}