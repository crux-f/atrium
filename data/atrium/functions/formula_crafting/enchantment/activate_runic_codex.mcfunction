...
execute positioned ~ ~-1 ~8 as @e[tag=runic_codex,distance=..3,limit=1,sort=nearest] at @s run function atrium:formula_crafting/enchantment/enchantment_base_item
