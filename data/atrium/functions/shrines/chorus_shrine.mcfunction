...
execute unless entity @p[distance=..5,scores={chorus_favor=30..},gamemode=!spectator] run scoreboard players add @p[distance=..5,level=1..,nbt=!{SelectedItem:{id:"minecraft:golden_apple"}}] chorus_favor 2
...
# Religion Noises!
playsound minecraft:atrium.favor.chorus master @a[distance=..8] ~ ~ ~ 0.5 1 0.1
