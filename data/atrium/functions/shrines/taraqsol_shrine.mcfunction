...
execute unless entity @p[distance=..5,scores={taraqsol_favor=30..}] run scoreboard players add @p[distance=..5,level=1..,nbt=!{SelectedItem:{id:'minecraft:diamond'}}] taraqsol_favor 2
