...
execute unless entity @p[distance=..5,scores={syrula_favor=30..}] run scoreboard players add @p[distance=..5,level=1..,nbt=!{SelectedItem:{id:"minecraft:golden_apple"}}] syrula_favor 2
