...
execute at @s run particle minecraft:smoke ~ ~1.5 ~ 0.1 0.5 0.1 0.1 15 normal
execute at @s run playsound atrium:favor.nameless neutral @a[distance=..8] ~ ~ ~ 0.75 1 0.1
...
execute if entity @s[scores={nameless_favor=1..9}] run effect give @s minecraft:water_breathing 300 0
...
execute if entity @s[scores={nameless_favor=10..19}] run effect give @s minecraft:water_breathing 450 0
...
execute if entity @s[scores={nameless_favor=20..29}] run effect give @s minecraft:water_breathing 900 0
...
execute if entity @s[scores={nameless_favor=30}] run effect give @s minecraft:water_breathing 1700 0
...
execute if entity @s[scores={nameless_favor=20}] run advancement grant @s only atrium:belief/nameless_20
