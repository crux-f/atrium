...
execute unless entity @p[distance=..5,scores={oswald_favor=30..}] run scoreboard players add @p[distance=..5,level=1..,nbt=!{SelectedItem:{id:'minecraft:diamond'}}] oswald_favor 2
