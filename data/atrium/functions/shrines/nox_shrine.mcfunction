...
execute unless entity @p[distance=..5,scores={nox_favor=30..}] run scoreboard players add @p[distance=..5,level=1..,nbt=!{SelectedItem:{id:"minecraft:golden_apple"}}] nox_favor 2
