...
execute unless entity @p[distance=..5,scores={quipster_favor=30..}] run scoreboard players add @p[distance=..5,level=1..,nbt=!{SelectedItem:{id:"minecraft:golden_apple"}}] quipster_favor 2
