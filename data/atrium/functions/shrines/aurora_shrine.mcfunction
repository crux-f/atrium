...
execute unless entity @p[distance=..5,scores={aurora_favor=30..},gamemode=!spectator] run scoreboard players add @p[distance=..5,level=1..,nbt=!{SelectedItem:{id:"minecraft:golden_apple"}}] aurora_favor 2
