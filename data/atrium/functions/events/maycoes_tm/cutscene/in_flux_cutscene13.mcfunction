tellraw @a[tag=event] ["",{"text":"[Maycoes]: ","color":"dark_purple"},{"text":"As ready for battle as ever, eh?","color":"white"}]
execute at @e[tag=event] run playsound minecraft:atrium.maycoes_talk_3 master @a[tag=event] ~ ~ ~ 0.5 0.7 1
#
schedule function atrium:events/maycoes_tm/cutscene/in_flux_cutscene14 6s
#
