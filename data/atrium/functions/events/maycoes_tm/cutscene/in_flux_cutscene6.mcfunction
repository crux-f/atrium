tellraw @a[tag=event] ["",{"text":"[Pyronicus]: ","color":"red"},{"text":"I've seen some of you before, at Prophet's Cauldron!","color":"white"}]
execute at @e[tag=event] run playsound minecraft:entity.skeleton.ambient master @a[tag=event] ~ ~ ~ 5 0.7 1
#
schedule function atrium:events/maycoes_tm/cutscene/in_flux_cutscene7 6s
#
