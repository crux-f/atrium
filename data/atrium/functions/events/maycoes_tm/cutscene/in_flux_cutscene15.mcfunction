tellraw @a[tag=event] ["",{"text":"[Maycoes]: ","color":"dark_purple"},{"text":"Personally.","color":"white"}]
execute at @e[tag=event] run playsound minecraft:atrium.maycoes_talk_1 master @a[tag=event] ~ ~ ~ 0.5 0.7 0.5
#
schedule function atrium:events/maycoes_tm/cutscene/in_flux_cutscene16 8s
#
