tellraw @a[tag=event] ["",{"text":"[Maycoes]: ","color":"dark_purple"},{"text":"It's been an awfully long time since I have had to deal with Viators..","color":"white"}]
execute at @e[tag=event] run playsound minecraft:atrium.maycoes_talk_1 master @a[tag=event] ~ ~ ~ 0.5 1.3 0.5
#
schedule function atrium:events/maycoes_tm/cutscene/in_flux_cutscene15 6s
#
