tellraw @a[tag=event] ["",{"text":"[Mysterious Figure]: ","color":"dark_red"},{"text":"Viators.","color":"white"}]
execute at @e[tag=event] run playsound minecraft:entity.wither_skeleton.ambient master @a[tag=event] ~ ~ ~ 3 0.8 1
#
schedule function atrium:events/maycoes_tm/cutscene/in_flux_cutscene6 5s
#
