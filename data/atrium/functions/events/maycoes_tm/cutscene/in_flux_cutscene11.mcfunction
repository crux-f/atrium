tellraw @a[tag=event] ["",{"text":"[Maycoes]: ","color":"dark_purple"},{"text":"Mind your manners. You still have work to do.","color":"white"}]
execute at @e[tag=event] run playsound minecraft:atrium.maycoes_talk_2 master @a[tag=event] ~ ~ ~ 0.5 1 1
#
schedule function atrium:events/maycoes_tm/cutscene/in_flux_cutscene12 5s
#
