tellraw @a[tag=event] ["",{"text":"[Maycoes]: ","color":"dark_purple"},{"text":"I applaud you, genuinely. Your efforts cost me many lives, and many resources.","color":"white"}]
execute at @e[tag=event] run playsound minecraft:atrium.maycoes_talk_1 master @a[tag=event] ~ ~ ~ 0.5 0.8 1
#
schedule function atrium:events/maycoes_tm/time_stop/timestop_cutscene11 6s
#
