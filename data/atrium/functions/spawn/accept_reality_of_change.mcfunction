...
# Revoke old start
advancement revoke @p[distance=..10,gamemode=!spectator] only atrium:air_start
advancement revoke @p[distance=..10,gamemode=!spectator] only atrium:earth_start
advancement revoke @p[distance=..10,gamemode=!spectator] only atrium:fire_start
advancement revoke @p[distance=..10,gamemode=!spectator] only atrium:water_start
# teleport to Randomization Tube(tm)
execute in atrium:between_worlds run tp @p[distance=..10,gamemode=!spectator] 36734.5 231 -3235.5
