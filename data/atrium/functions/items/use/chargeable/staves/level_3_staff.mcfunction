...
execute if data entity @s {Inventory:[{Slot:-106b,tag:{atrium_air_staff:1b}}]} run item replace entity @s hotbar.8 with minecraft:firework_star{display:{Name:'{"text":"Cast: Dance","color":"dark_gray","italic":false}'},atrium_power_slot:4b,atrium_power:1b,CustomModelData:333016} 1
#
...
execute if data entity @s {Inventory:[{Slot:-106b,tag:{atrium_earth_staff:1b}}]} run item replace entity @s hotbar.8 with minecraft:firework_star{display:{Name:'{"text":"Cast: Return","color":"dark_gray","italic":false}'},atrium_power_slot:4b,atrium_power:1b,CustomModelData:333017} 1
#
...
execute if data entity @s {Inventory:[{Slot:-106b,tag:{atrium_fire_staff:1b}}]} run item replace entity @s hotbar.8 with minecraft:firework_star{display:{Name:'{"text":"Cast: Meteor","color":"dark_gray","italic":false}'},atrium_power_slot:4b,atrium_power:1b,CustomModelData:333018} 1
#
...
execute if data entity @s {Inventory:[{Slot:-106b,tag:{atrium_water_staff:1b}}]} run item replace entity @s hotbar.8 with minecraft:firework_star{display:{Name:'{"text":"Cast: Flush","color":"dark_gray","italic":false}'},atrium_power_slot:4b,atrium_power:1b,CustomModelData:333019} 1
#
...
execute if data entity @s {Inventory:[{Slot:-106b,tag:{atrium_time_staff:1b}}]} run item replace entity @s hotbar.8 with minecraft:firework_star{display:{Name:'{"text":"Cast: ???","color":"dark_gray","italic":false}'},atrium_power_slot:4b,atrium_power:1b,CustomModelData:333020} 1
#
...
execute if data entity @s {Inventory:[{Slot:-106b,tag:{atrium_space_staff:1b}}]} run item replace entity @s hotbar.8 with minecraft:firework_star{display:{Name:'{"text":"Cast: ???","color":"dark_gray","italic":false}'},atrium_power_slot:4b,atrium_power:1b,CustomModelData:333021} 1