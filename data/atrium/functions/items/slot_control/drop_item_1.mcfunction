...
summon item ~ ~ ~ {PickupDelay:2,Tags:["atrium_drop_1"],Item:{id:"minecraft:egg",Count:1b,tag:{display:{Name:'{"text":"Extremely Reportable Egg","italic":false}',Lore:['{"text":"(report this to crux_f)"}']}}}}
