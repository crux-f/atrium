...
execute run data merge entity @e[limit=1,tag=going_haywire] {AngryAt:[I;110787060,1156138790,-1514210135,238594805],AngerTime:99999,Health:60f,Attributes:[{Name:"generic.follow_range", Base:70.0}]}
execute as @a[limit=1,distance=..70,tag=!spectator] run data modify entity @e[limit=1,tag=going_haywire,nbt={AngryAt:[I;110787060,1156138790,-1514210135,238594805]}] AngryAt set from entity @s UUID
#
# Remove temp tag
