...
execute if entity @s[scores={charge=0..2}] run data merge entity @s {Gossips:[{Type:"minor_negative",Value:30,Target:[I;110787060,1156138790,-1514210135,238594805]}]}
...
execute if entity @s[scores={charge=3..6}] run data merge entity @s {Gossips:[{Type:"minor_negative",Value:40,Target:[I;110787060,1156138790,-1514210135,238594805]}]}
...
execute if entity @s[scores={charge=7..12}] run data merge entity @s {Gossips:[{Type:"minor_negative",Value:50,Target:[I;110787060,1156138790,-1514210135,238594805]}]}
...
execute if entity @s[scores={charge=13..24}] run data merge entity @s {Gossips:[{Type:"minor_negative",Value:60,Target:[I;110787060,1156138790,-1514210135,238594805]}]}
