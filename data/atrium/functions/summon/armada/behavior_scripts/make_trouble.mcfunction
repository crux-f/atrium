...
execute if entity @s[scores={charge=0..2}] if predicate atrium:percentage_chances/0.10_p run function atrium:summon/armada/behavior_scripts/promote_sleeper_agent
#
