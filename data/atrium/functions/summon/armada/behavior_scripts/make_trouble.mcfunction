...
execute at @s[scores={charge=0..6}] if predicate atrium:percentage_chances/0.25_p run function atrium:summon/armada/behavior_scripts/rewire_golem
#
# If their score is 7-12, they have a 15% chance of permenantly hijacking a local iron golem.
execute at @s[scores={charge=7..12}] if predicate atrium:percentage_chances/0.15_p run function atrium:summon/armada/behavior_scripts/hijack_golem
#
