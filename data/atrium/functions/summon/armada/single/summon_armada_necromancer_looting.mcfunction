...
summon evoker ~ ~ ~ {Team:"armada",PersistenceRequired:1b,Health:48f,Tags:["armada_necromancer","armada_hiding"],CustomName:'{"text":"Armada Necromancer","color":"red","italic":false}',Attributes:[{Name:"generic.max_health",Base:48}]}
#
